import{u as v,r as C,j as e,L as u}from"./index-Dsh58Aqf.js";import{c as a,m as o,M as A}from"./Modal-CWVCr5s9.js";import{C as c,E as g,T as h,S as k,a as F,U as x}from"./users-Ce-wVotU.js";const M=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],S=a("arrow-left",M);const R=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],T=a("book-open",R);const I=[["path",{d:"M10 12h4",key:"a56b0p"}],["path",{d:"M10 8h4",key:"1sr2af"}],["path",{d:"M14 21v-3a2 2 0 0 0-4 0v3",key:"1rgiei"}],["path",{d:"M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2",key:"secmi2"}],["path",{d:"M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16",key:"16ra0t"}]],j=a("building-2",I);const w=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],p=a("chevron-right",w);const N=[["path",{d:"M12 6v6l4 2",key:"mmk7yg"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]],l=a("clock",N);const P=[["path",{d:"M12 3v18",key:"108xh3"}],["path",{d:"m19 8 3 8a5 5 0 0 1-6 0zV7",key:"zcdpyk"}],["path",{d:"M3 7h1a17 17 0 0 0 8-2 17 17 0 0 0 8 2h1",key:"1yorad"}],["path",{d:"m5 8 3 8a5 5 0 0 1-6 0zV7",key:"eua70x"}],["path",{d:"M7 21h10",key:"1b0cd5"}]],L=a("scale",P),f=[{id:"largest-fca-fines-history",title:"The Largest FCA Fines in History: A Comprehensive Analysis",excerpt:"Explore the most significant financial penalties ever issued by the FCA, from Barclays' £284 million fine to landmark enforcement actions that shaped regulatory standards.",content:`
## Overview
...
- More proactive engagement with regulators
    `,category:"Case Studies",readTime:"8 min read",date:"January 2025",icon:e.jsx(L,{className:"blog-card-icon"}),featured:!0},{id:"understanding-breach-categories",title:"Understanding FCA Breach Categories: A Complete Guide",excerpt:"A detailed breakdown of all breach categories used by the FCA in enforcement actions, helping firms understand regulatory priorities and risk areas.",content:`
## Introduction
...
4. **Crypto asset activities**: Emerging regulatory framework
    `,category:"Regulatory Guidance",readTime:"10 min read",date:"December 2024",icon:e.jsx(T,{className:"blog-card-icon"})},{id:"year-on-year-trends",title:"FCA Enforcement Trends: Year-on-Year Analysis 2013-2025",excerpt:"Analyse how FCA enforcement has evolved over the years, including fine volumes, average penalties, and shifting regulatory priorities.",content:`
## Executive Summary
...
| Q4 2024 | £312m | 15 |
| Q1 2025 | £178m | 7 |
    `,category:"Analysis",readTime:"12 min read",date:"January 2025",icon:e.jsx(h,{className:"blog-card-icon"}),featured:!0},{id:"compliance-best-practices",title:"Building a Robust Compliance Framework: Lessons from FCA Fines",excerpt:"Practical guidance on establishing effective compliance controls based on common failures identified in FCA enforcement actions.",content:`
## Introduction
...
5. **Regulatory Findings**: External examination results
    `,category:"Best Practices",readTime:"15 min read",date:"November 2024",icon:e.jsx(k,{className:"blog-card-icon"})},{id:"aml-enforcement-deep-dive",title:"AML Enforcement: Why Anti-Money Laundering Failures Dominate FCA Fines",excerpt:"An in-depth analysis of anti-money laundering enforcement actions, examining why AML failures account for the largest share of FCA penalties.",content:`
...
5. **External Validation**: Independent reviews and testing
    `,category:"Deep Dive",readTime:"14 min read",date:"October 2024",icon:e.jsx(F,{className:"blog-card-icon"})},{id:"sector-analysis-banking",title:"Banking Sector Fines: Patterns and Prevention Strategies",excerpt:"A focused analysis of enforcement actions against banks, revealing sector-specific risks and tailored compliance strategies.",content:`
...
- Faster resolution
    `,category:"Sector Analysis",readTime:"11 min read",date:"September 2024",icon:e.jsx(j,{className:"blog-card-icon"})},{id:"senior-managers-regime",title:"The Senior Managers Regime: Personal Accountability and FCA Enforcement",excerpt:"Understanding how the Senior Managers & Certification Regime has changed individual accountability and what this means for enforcement.",content:`
...
5. **Evidence of appropriate challenge**
    `,category:"Regulatory Framework",readTime:"13 min read",date:"August 2024",icon:e.jsx(x,{className:"blog-card-icon"})},{id:"future-enforcement-priorities",title:"FCA Enforcement Priorities for 2025 and Beyond",excerpt:"Forward-looking analysis of where the FCA is likely to focus enforcement efforts, based on regulatory signals and industry trends.",content:`
...
Firms that proactively address these priority areas will be better positioned to avoid enforcement action and maintain positive regulatory relationships.
    `,category:"Future Outlook",readTime:"11 min read",date:"January 2025",icon:e.jsx(h,{className:"blog-card-icon"}),featured:!0}];function q(){const d=v(),[i,t]=C.useState(null),y=f.filter(n=>n.featured),b=f.filter(n=>!n.featured),m=n=>{t(n)};return e.jsxs("div",{className:"blog-page",children:[e.jsx("header",{className:"blog-header",children:e.jsxs("div",{className:"blog-header-content",children:[e.jsxs(u,{to:"/",className:"blog-back-link",children:[e.jsx(S,{size:20}),e.jsx("span",{children:"Back to Home"})]}),e.jsx("nav",{className:"blog-nav",children:e.jsx(u,{to:"/dashboard",className:"blog-nav-link",children:"Dashboard"})})]})}),e.jsx("section",{className:"blog-hero",children:e.jsxs(o.div,{className:"blog-hero-content",initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6},children:[e.jsx("h1",{children:"FCA Fines Insights"}),e.jsx("p",{className:"blog-hero-subtitle",children:"In-depth analysis, case studies, and expert guidance on FCA enforcement actions"})]})}),e.jsxs("section",{className:"blog-section",children:[e.jsxs("div",{className:"blog-section-header",children:[e.jsx("h2",{children:"Featured Articles"}),e.jsx("p",{children:"Essential reading for compliance professionals"})]}),e.jsx("div",{className:"blog-featured-grid",children:y.map((n,s)=>e.jsxs(o.article,{className:"blog-card blog-card--featured",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:s*.1},onClick:()=>m(n),children:[e.jsxs("div",{className:"blog-card-header",children:[e.jsx("span",{className:"blog-card-category",children:n.category}),e.jsx("span",{className:"blog-card-featured-badge",children:"Featured"})]}),e.jsx("div",{className:"blog-card-icon-wrapper",children:n.icon}),e.jsx("h3",{className:"blog-card-title",children:n.title}),e.jsx("p",{className:"blog-card-excerpt",children:n.excerpt}),e.jsxs("div",{className:"blog-card-meta",children:[e.jsxs("span",{className:"blog-card-meta-item",children:[e.jsx(c,{size:14}),n.date]}),e.jsxs("span",{className:"blog-card-meta-item",children:[e.jsx(l,{size:14}),n.readTime]})]}),e.jsxs("button",{className:"blog-card-cta",children:["Read Article",e.jsx(p,{size:16})]})]},n.id))})]}),e.jsxs("section",{className:"blog-section blog-section--alt",children:[e.jsxs("div",{className:"blog-section-header",children:[e.jsx("h2",{children:"All Articles"}),e.jsx("p",{children:"Comprehensive coverage of FCA enforcement and compliance"})]}),e.jsx("div",{className:"blog-grid",children:b.map((n,s)=>e.jsxs(o.article,{className:"blog-card",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:s*.1},onClick:()=>m(n),children:[e.jsx("div",{className:"blog-card-header",children:e.jsx("span",{className:"blog-card-category",children:n.category})}),e.jsx("div",{className:"blog-card-icon-wrapper",children:n.icon}),e.jsx("h3",{className:"blog-card-title",children:n.title}),e.jsx("p",{className:"blog-card-excerpt",children:n.excerpt}),e.jsxs("div",{className:"blog-card-meta",children:[e.jsxs("span",{className:"blog-card-meta-item",children:[e.jsx(c,{size:14}),n.date]}),e.jsxs("span",{className:"blog-card-meta-item",children:[e.jsx(l,{size:14}),n.readTime]})]}),e.jsxs("button",{className:"blog-card-cta",children:["Read Article",e.jsx(p,{size:16})]})]},n.id))})]}),e.jsx("section",{className:"blog-cta-section",children:e.jsxs("div",{className:"blog-cta-content",children:[e.jsx("h2",{children:"Explore the Full Dashboard"}),e.jsx("p",{children:"Dive deeper into FCA enforcement data with our interactive analytics platform. Filter by year, category, firm, and more."}),e.jsxs("button",{className:"blog-cta-button",onClick:()=>d("/dashboard"),children:["Open Dashboard",e.jsx(g,{size:18})]})]})}),e.jsx("footer",{className:"blog-footer",children:e.jsxs("div",{className:"blog-footer-content",children:[e.jsxs("div",{className:"blog-footer-brand",children:[e.jsx("p",{className:"blog-footer-logo",children:"FCA Fines Dashboard"}),e.jsx("p",{className:"blog-footer-tagline",children:"Powered by MEMA Consultants"})]}),e.jsxs("p",{className:"blog-footer-copyright",children:["© ",new Date().getFullYear()," MEMA Consultants · All rights reserved"]})]})}),i&&e.jsx(A,{isOpen:!!i,onClose:()=>t(null),title:i.title,children:e.jsxs("div",{className:"blog-article-modal",children:[e.jsxs("div",{className:"blog-article-modal-header",children:[e.jsx("span",{className:"blog-card-category",children:i.category}),e.jsxs("div",{className:"blog-card-meta",children:[e.jsxs("span",{className:"blog-card-meta-item",children:[e.jsx(c,{size:14}),i.date]}),e.jsxs("span",{className:"blog-card-meta-item",children:[e.jsx(l,{size:14}),i.readTime]})]})]}),e.jsx("div",{className:"blog-article-content",dangerouslySetInnerHTML:{__html:i.content.replace(/^## (.+)$/gm,"<h2>$1</h2>").replace(/^### (.+)$/gm,"<h3>$1</h3>").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/^\- (.+)$/gm,"<li>$1</li>").replace(/(<li>.*<\/li>\n?)+/g,"<ul>$&</ul>").replace(/\n\n/g,"</p><p>").replace(/\|(.+)\|/g,n=>`<tr>${n.split("|").filter(Boolean).map(r=>r.trim()).map(r=>`<td>${r}</td>`).join("")}</tr>`)}}),e.jsx("div",{className:"blog-article-modal-footer",children:e.jsxs("button",{className:"blog-cta-button",onClick:()=>{t(null),d("/dashboard")},children:["Explore Dashboard Data",e.jsx(g,{size:18})]})})]})})]})}export{q as Blog};
