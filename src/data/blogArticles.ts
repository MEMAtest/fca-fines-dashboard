...
This analysis uses 11 topic-filtered actions linked to official regulatory sources across 5 regulators: FMA AT, FMA NZ, FCA, FINRA, OCC. The records cover 2025-06-04 to 2026-08-18. 3 records contain a monetary penalty verified against the evidence contract. Monetary values retain their source currency; GBP-normalised values are reserved for explicitly labelled aggregate charts. Other records may describe cancellations, prohibitions, investigations, orders or sanctions whose monetary value is not verified. The selection supports this article's analysis but is not a complete catalogue of every action in the period.`,
  ...
  {
    id: "ai-regulatory-roundup-september-2026",
    slug: "regulatory-roundup-september-2026",
    title: "Regulatory Roundup: September 2026 Enforcement Actions Analysed",
    seoTitle: "Regulatory Roundup: September 2026 Enforcement Actions Analysed | RegActions",
...
September 2026 saw a high volume of supervisory and organisational actions, with European authorities issuing monetary penalties. BaFin fined H2 Core AG EUR 50,000 for financial reporting failures and a.i.s. AG EUR 15,000 for securities disclosure violations. De Nederlandsche Bank (DNB) fined GMG Europe B.V. EUR 59,770 for capital shortfalls.

Several significant non-monetary actions were also recorded. BaFin ordered Cadence Growth Capital GmbH to submit specific contracts and documents to fulfil its anti-money laundering due diligence obligations. The UK Financial Conduct Authority (FCA) issued final notices against Professional Liability Network and O B Payments Ltd.

These actions highlight a continued regulatory focus on financial reporting, securities disclosure, and anti-money laundering compliance across Europe. Regulators are actively enforcing standards to maintain market integrity, with varied penalties reflecting diverse breaches. Firms must ensure robust internal controls and adherence to regulatory requirements.

## Key Enforcement Actions

In September 2026, European and Hong Kong regulators took enforcement actions, including fines for reporting and capital breaches, alongside non-monetary orders.

BaFin imposed two fines for securities reporting violations: H2 Core AG was fined EUR 50,000 for financial reporting failures, and a.i.s. AG received a fine of EUR 15,000 for failing to disclose public access details for its 2025 annual financial information. De Nederlandsche Bank (DNB) fined GMG Europe B.V. EUR 59,770 for capital shortfalls.

BaFin also issued two non-monetary orders. It instructed Cadence Growth Capital GmbH to submit contracts and documents to demonstrate compliance with anti-money laundering due diligence obligations concerning Placement Agents. BaFin ordered Landwirtschaftliche Rentenbank to rectify organisational deficiencies and hold additional capital until these governance issues are resolved.

Beyond Europe, the Hong Kong Securities and Futures Commission (SFC) directed the suspension of dealings in Cloudbreak Pharma Inc. shares due to suspected irregularities in its initial public offering process. The UK's Office of Financial Sanctions Implementation (OFSI) published a penalty notice for Citibank, N.A., London Branch, for breaches of financial sanctions regulations.

These actions highlight a continued regulatory focus on financial integrity, market transparency, and robust governance across different jurisdictions. Firms must ensure strict adherence to reporting, capital, and anti-money laundering requirements, as non-compliance can lead to significant penalties and operational restrictions. Regulators are actively monitoring and enforcing these standards, using a range of tools from monetary fines to operational directives to ensure compliance and maintain stability and trust within financial markets.

| Regulator | Firm/Individual | Amount (EUR) |
|---|---|---|
| BaFin | H2 Core AG | 50,000 |
| DNB | GMG Europe B.V. | 59,770 |
| BaFin | a.i.s. AG | 15,000 |

BaFin's actions against H2 Core AG and a.i.s. AG demonstrate a focus on timely and transparent financial disclosures. The DNB's fine on GMG Europe B.V. highlights the importance of maintaining adequate capital. These monetary penalties serve as a deterrent against non-compliance.

Non-monetary actions by BaFin against Cadence Growth Capital GmbH and Landwirtschaftliche Rentenbank address systemic issues. Cadence Growth Capital GmbH's order focused on anti-money laundering due diligence, while Landwirtschaftliche Rentenbank's order addressed organisational deficiencies and capital requirements. These directives aim to improve internal controls and governance.

The SFC's suspension of Cloudbreak Pharma Inc. shares indicates a strong stance against market irregularities. OFSI's penalty notice for Citibank, N.A., London Branch, reinforces the strict enforcement of financial sanctions. These actions demonstrate a broad regulatory scope, covering market integrity and international compliance.

## Analysis

September 2026 enforcement data shows regulatory divergence. European actions, led by BaFin and DNB, feature monetary penalties for specific technical and reporting failures. BaFin fined H2 Core AG EUR 50,000 for financial reporting failures and a.i.s. AG EUR 15,000 for a securities disclosure violation related to its 2025 annual financial information. DNB fined GMG Europe B.V. EUR 59,770 for banking supervision breaches. These actions address breaches of defined statutory obligations.

North American actions, as seen with FINRA, focus on individual conduct and procedural integrity. FINRA took action against J.P. Morgan Securities LLC for failing to establish procedures to ensure customers received required margin account disclosures. FINRA also took action against Daniel G. Diaz, who was barred for refusing to provide on-the-record testimony, and Daniel Schmid, who was sanctioned for providing false testimony and withholding documents to conceal an improper customer loan.

This pattern highlights jurisdictional emphasis. European regulators apply financial penalties to corporate entities for technical compliance failures, while North American authorities prioritise non-monetary sanctions targeting individual accountability and the integrity of supervisory processes, including internal controls and investigative cooperation. This divergence in enforcement strategies reflects differing regulatory philosophies: European regulators focus on strict adherence to financial reporting and capital requirements, while North American regulators emphasise individual responsibility and transparency in investigations. Both approaches aim to maintain market integrity and investor protection.

## Regulatory Implications

The actions documented for September 2026 illustrate a clear regulatory focus on foundational governance and the accuracy of public disclosures. European authorities, in particular, are willing to impose direct financial penalties for specific procedural lapses. BaFin's EUR 15,000 fine against a.i.s. AG for failing to properly publish the access details for its annual financial information demonstrates strict, rules-based enforcement of basic securities law obligations.

Beyond fines, regulators are deploying a range of intrusive supervisory tools to compel corrective action and secure compliance. BaFin ordered Cadence Growth Capital GmbH to produce specific contracts and documents to fulfil its anti-money laundering due diligence obligations. In a separate action, BaFin required Landwirtschaftliche Rentenbank to rectify organisational deficiencies and hold additional capital until the issues are resolved. These measures signal a shift towards prescriptive, interventionist supervision aimed at remediating control weaknesses.

Globally, authorities are acting decisively on disclosure integrity and market conduct. The SFC suspended dealings in Cloudbreak Pharma Inc. shares over serious concerns about its initial public offering. ASIC issued infringement notices to Tetra Servicing Pty Ltd and two other superannuation funds for misleading investment disclosures. Similarly, FINRA sanctioned J.P. Morgan Securities LLC for long-standing failures in providing required margin account disclosures. These cases collectively underscore that robust internal controls, meticulous documentation, and precise public communication are non-negotiable priorities for firms across jurisdictions.

## Key Takeaways

* BaFin fined a.i.s. AG €15,000 for failing to publicly disclose the availability and internet address of its 2025 annual financial information.
* BaFin ordered Cadence Growth Capital GmbH to submit contracts with placement agents and other documents to fulfil customer due diligence obligations.
* Landwirtschaftliche Rentenbank was directed by BaFin to ensure its business organisation is proper and to hold additional own funds until organisational deficiencies are rectified.
* FINRA found that Colorado Financial Service Corporation failed to adequately supervise recommendations of complex and speculative closed-end funds.
* J.P. Morgan Securities LLC did not establish procedures to ensure certain customers received required margin account disclosures on account statements between October 2010 and September 2024.
* Xing Su engaged in outside business activities without providing prior written notice to his firm, involving consulting services to increase investor interest in companies.

## About the Data

This analysis uses 19 topic-filtered actions linked to official regulatory sources across 10 regulators: BaFin, DNB, FCA, SFC, CVM, FINRA, CIRO, FSMA, ASIC, OFSI. The records cover 2026-09-01 to 2026-09-11. Three records contain a monetary penalty verified against the evidence contract. Monetary values retain their source currency; GBP-normalised values are reserved for explicitly labelled aggregate charts. Other records may describe cancellations, prohibitions, investigations, orders or sanctions whose monetary value is not verified. The selection supports this article's analysis but is not a complete catalogue of every action in the period.`,
    category: "Enforcement Roundup",
    readTime: "7 min read",
    date: "14 September 2026",
    dateISO: "2026-09-14",
    keywords: ["Regulatory Enforcement","BaFin","FINRA","Financial Reporting","Supervisory Violations","September 2026","Compliance Failures","Securities Law"],
    status: "published",
    generatedBy: "ai",
    generatedAt: "2026-09-14T09:00:01.584Z",
    articleType: "monthly",
    editorialManifest: {"version":1,"status":"published","contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32","generatedAt":"2026-09-14T09:00:01.584Z","generationModel":"deepseek/deepseek-v3.2","promptVersion":"regactions-editorial-v2.1","sources":[{"id":"source:de2e0959-06bd-4d03-99cb-cc3cceabbf4a","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Massnahmen/40c_neu_124_WpHG/meldung_2026_09_08_h2_core_ag.html","title":"BaFin action concerning H2 Core AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-08. Verified penalty amount: EUR 50000. Evidence summary: Das Bundesamt für Justiz hat am 17. Juni 2026 ein Ordnungsgeld in Höhe von 50.000 Euro zulasten der H2 Core AG festgesetzt."},{"id":"source:d77bb59f-2c77-4937-80c4-11e9433101e9","url":"https://www.dnb.nl/en/general-news/enforcement-measures-2026/fine-imposed-on-gmg-europe-b-v-for-repeated-capital-shortfalls/","title":"DNB action concerning GMG Europe B.V.","publisher":"DNB","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-07. Verified penalty amount: EUR 59770. Evidence summary: GMG Europe B.V. fined by DNB for On 22 June 2026, De Nederlandsche Bank (DNB) imposed an administrative fine of &#x20AC;59,770 on investment firm GMG Europe B.V. (GMG)."},{"id":"source:835923e0-34ac-4290-883b-0859085de789","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Massnahmen/40c_neu_124_WpHG/meldung_2026_09_01_a_i_s_ag.html","title":"BaFin action concerning a.i.s. AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-01. Verified penalty amount: EUR 15000. Evidence summary: Die Finanzaufsicht Bafin hat am 19. August 2026 eine Geldbuße in Höhe von 15.000 Euro gegen die a.i.s. AG festgesetzt. Die a.i.s. AG hatte nicht mittels Hinweisbekanntmachung darüber informiert, ab welchem Zeitpunkt und unter welcher Internetadresse die Jahresfinanzinformationen für das Geschäftsjahr 2025 öffentlich zugänglich waren. Dies stellt einen Verstoß gegen das Wertpapierhandelsgesetz (WpHG) dar."},{"id":"source:FCA-2026-09-11-professional-liability-network-1972fb34","url":"https://www.fca.org.uk/publication/final-notices/professional-liability-network-2026.pdf","title":"FCA action concerning Professional Liability Network","publisher":"FCA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-11. No verified penalty amount. Evidence summary: Final Notice 2026: Professional Liability Network"},{"id":"source:060953e3-4005-4b7a-8ab4-ba4936829738","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Massnahmen/60b_KWG_84_WpIG_und_57_GwG/meldung_2026_09_11_cadence_growth_capital_gmbh.html","title":"BaFin action concerning Cadence Growth Capital GmbH","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-11. No verified penalty amount. Evidence summary: Die Cadence Growth Capital GmbH hat der Bafin Verträge mit Placement Agents sowie weitere Dokumente zur Erfüllung der Kundensorgfaltspflichten nach dem Geldwäschegesetz (GwG) vorzulegen. Das hat die Finanzaufsicht Bafin angeordnet. Die Anordnung der Bafin soll sicherstellen, dass zukünftig bei Begründung von neuen Geschäftsbeziehungen zu Placement Agents die Kundensorgfaltspflichten durch die Cadence Growth Capital GmbH eingehalten werden."},{"id":"source:FCA-2026-09-11-o-b-payments-ltd-7de8fe6c","url":"https://www.fca.org.uk/publication/final-notices/o-b-payments-ltd-2026.pdf","title":"FCA action concerning O B Payments Ltd","publisher":"FCA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-11. No verified penalty amount. Evidence summary: Final Notice 2026: O B Payments Ltd"},{"id":"source:4a7bfc2c-9517-4ffb-898b-970c723b4d0e","url":"https://apps.sfc.hk/edistributionWeb/gateway/EN/news-and-announcements/news/doc?refNo=26PR140","title":"SFC action concerning dealings in Cloudbreak Pharma Inc. shares","publisher":"SFC","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-10. No verified penalty amount. Evidence summary: The Securities and Futures Commission (SFC) has directed The Stock Exchange of Hong Kong Limited (SEHK) to suspend dealings in the shares of Cloudbreak Pharma Inc. (Cloudbreak) (Stock Code: 02592) under section 8(1) of the Securities and Futures (Stock Market Listing) Rules (SMLR), with effect from 9:00 am on 10 September 2026 (Notes 1 and 2). The SFC has serious concerns that Cloudbreak’s initial public offering (IPO) may have been rigged to create an artificial impression of demand for Cloudbr"},{"id":"source:5dc9e22c-eb84-4aa4-8be5-27ad500f58c0","url":"https://dados.cvm.gov.br/dataset/processo-sancionador","title":"CVM action concerning AMÉRICO MACIEL DE SOUZA","publisher":"CVM","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-10. No verified penalty amount. Evidence summary: AMÉRICO MACIEL DE SOUZA appears in the official CVM sanction-proceedings dataset under process 19957011331202561. Status: GCP envia GRU para pagamento de multa. Apurar a responsabilidade de assessor de investimento em razão da utilização de senhas e logins de clientes para a realização de operações em nome destes, bem como no envio de relatórios e extratos falsos com o objetivo de ocultar as perdas incorridas. Phase: Intimação após julgamento / Fim da etapa de apresentação de recurso."},{"id":"source:3014c23e-35fc-4645-9441-332e0183efad","url":"https://data-portal.finra.org/fda_documents/2023077597702%20Colorado%20Financial%20Service%20Corporation%20CRD%20104343%20AWC%20lp.pdf","title":"FINRA action concerning Colorado Financial Service Corporation","publisher":"FINRA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-09. No verified penalty amount. Evidence summary: Closed-end funds (CEFs) offer investment advantages such as access to specialized or illiquid assets. They may, however, present unique risks based on their complexity, illiquidity, leverage, and/or investment in speculative assets. From March 2021 to at least February 2023, Colorado Financial fa..."},{"id":"source:7183471a-e4c0-4dfe-b7a1-e62632cba1d8","url":"https://www.ciro.ca/newsroom/publications/ciro-hearing-panel-issues-reasons-decision-matter-debojyoti-debo-majumder","title":"CIRO action concerning Debojyoti (Debo) Majumder","publisher":"CIRO","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-09. No verified penalty amount. Evidence summary: Decision notice published by CIRO under MFDR: CIRO Hearing Panel issues reasons for decision in the matter of Debojyoti (Debo) Majumder."},{"id":"source:e97c1ecf-3b14-4237-874f-145bed324e7b","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Massnahmen/60b_KWG_84_WpIG_und_57_GwG/meldung_2026_09_08_landwirtschaftliche_rentenbank.html","title":"BaFin action concerning Landwirtschaftliche Rentenbank","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-08. No verified penalty amount. Evidence summary: Die Landwirtschaftliche Rentenbank mit Sitz in Frankfurt am Main muss sicherstellen, dass ihre Geschäftsorganisation ordnungsgemäß ist. Zudem muss das Institut zusätzliche Eigenmittel vorhalten, bis die organisatorischen Mängel beseitigt sind. Das hat die Finanzaufsicht Bafin angeordnet."},{"id":"source:11655a81-c885-4d0e-ba8f-75f176bc1b94","url":"https://www.ciro.ca/newsroom/publications/ciro-sanctions-haimeng-wang","title":"CIRO action concerning Haimeng Wang","publisher":"CIRO","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-04. No verified penalty amount. Evidence summary: Decision notice published by CIRO under MFDR: CIRO Sanctions Haimeng Wang."},{"id":"source:9a06ecc8-473d-4b44-b06b-2827d910e6ee","url":"https://www.fsma.be/sites/default/files/media/files/2026-09/2026-09-04_beslissing2.pdf","title":"FSMA action concerning Monsieur Michel Weber et sa SRL en raison de manquements à la loi du 7 décembre 2016","publisher":"FSMA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-04. No verified penalty amount. Evidence summary: Amendes administratives prononcées à l’encontre de Monsieur Michel Weber et sa SRL en raison de manquements à la loi du 7 décembre 2016 (art. 10, 29 et 55)"},{"id":"source:a35ec390-5515-42e8-8be6-86aeb5a17e0d","url":"https://data-portal.finra.org/fda_documents/2024081737701%20J.P.%20Morgan%20Securities%20LLC%20CRD%2079%20AWC%20ks.pdf","title":"FINRA action concerning J.P. Morgan Securities LLC","publisher":"FINRA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-03. No verified penalty amount. Evidence summary: From October 2010 through September 2024, JPMS failed to establish procedures to assure that certain customers received margin account disclosures required by Rule 10b- 16(a)(2) of the Securities Exchange Act of 1934 (Exchange Act) on account statements. As a result, during the period of October ..."},{"id":"source:e5f12b43-e2b3-4faa-b509-7a35e298bead","url":"https://data-portal.finra.org/fda_documents/2024083689501%20Xing%20Su%20CRD%204031195%20AWC%20ks.pdf","title":"FINRA action concerning Xing Su","publisher":"FINRA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-03. No verified penalty amount. Evidence summary: Between December 2022 and May 2025, Su owned half of a company (Company A) that provided consulting services to public and private companies seeking to increase investor interest in their companies. Separately, Su also individually entered into a consulting contract to provide similar consulting ..."},{"id":"source:ba363968-8aff-4d1e-86f8-b2171cdcf99b","url":"https://www.asic.gov.au/about-asic/news-centre/find-a-media-release/2026-releases/26-212mr-three-super-funds-issued-infringement-notices-for-misleading-investment-disclosures","title":"ASIC action concerning Tetra Servicing Pty Ltd (formerly Telstra Super Pty Ltd)","publisher":"ASIC","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-03. No verified penalty amount. Evidence summary: Three super funds issued infringement notices for misleading investment disclosures"},{"id":"source:OFSI-2026-09-02-citibank-n-a-london-branch-cbna-london-4360c6b7","url":"https://assets.publishing.service.gov.uk/media/6a97e3ba5a0c25165ae46760/CBNA_London_Public_Penalty_Notice.pdf","title":"OFSI action concerning Citibank, N.A., London Branch (CBNA London)","publisher":"OFSI","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-02. No verified penalty amount. Evidence summary: Making funds available for the benefit of a designated person Regulation 11 and 12 of the Russia (Sanctions) (EU Exit) Regulations 2019 (“the Russia Regulations”) and Regulation 13 of the Global Anti-Corruption Sanctions Regulations 2021 (“the GAC Regulations”)."},{"id":"source:e564792d-9262-4767-b310-d73ee2b84c76","url":"https://data-portal.finra.org/fda_documents/2025085419901%20Daniel%20G.%20Diaz%20CRD%201715827%20AWC%20lp.pdf","title":"FINRA action concerning Daniel G. Diaz","publisher":"FINRA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-02. No verified penalty amount. Evidence summary: In July 2026, Diaz refused to appear for on-the-record testimony requested pursuant to FINRA Rule 8210. As a result, he violated FINRA Rules 8210 and 2010 and is barred from associating with any FINRA member in all capacities."},{"id":"source:ba7d84b4-cce4-4f9b-82b2-4810172233ab","url":"https://data-portal.finra.org/fda_documents/2024083956101%20Daniel%20Schmid%20CRD%206658306%20AWC%20lp.pdf","title":"FINRA action concerning Daniel Schmid","publisher":"FINRA","sourceType":"official_notice","retrievedAt":"2026-09-14T09:00:01.584Z","official":true,"excerpt":"Official evidence record date: 2026-09-01. No verified penalty amount. Evidence summary: In July 2024, Schmid borrowed [unverified monetary figure removed] from a customer, in violation of firm policies. During FINRA’s investigation in 2025 and 2026, Schmid provided false written responses and withheld documents responsive to Rule 8210 requests and provided false testimony to conceal the loan and a related busin..."}],"claims":[{"id":"claim-1","text":"BaFin imposed a fine of EUR 50,000 on H2 Core AG for financial reporting failures.","kind":"amount","sourceIds":["source:de2e0959-06bd-4d03-99cb-cc3cceabbf4a"],"recordIds":["de2e0959-06bd-4d03-99cb-cc3cceabbf4a"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms the fine of EUR 50,000 imposed on H2 Core AG for financial reporting failures."},{"id":"claim-2","text":"BaFin fined a.i.s. AG EUR 15,000 for failing to disclose public access details for its 2025 annual financial information.","kind":"amount","sourceIds":["source:835923e0-34ac-4290-883b-0859085de789"],"recordIds":["835923e0-34ac-4290-883b-0859085de789"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms the fine of EUR 15,000 imposed on a.i.s. AG for securities disclosure violations related to 2025 annual financial information."},{"id":"claim-3","text":"De Nederlandsche Bank (DNB) fined GMG Europe B.V. EUR 59,770 for capital shortfalls.","kind":"amount","sourceIds":["source:d77bb59f-2c77-4937-80c4-11e9433101e9"],"recordIds":["d77bb59f-2c77-4937-80c4-11e9433101e9"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms the fine of EUR 59,770 imposed on GMG Europe B.V. for capital shortfalls."},{"id":"claim-4","text":"BaFin ordered Cadence Growth Capital GmbH to submit contracts with placement agents and other documents to fulfil anti-money laundering due diligence obligations.","kind":"action_type","sourceIds":["source:060953e3-4005-4b7a-8ab4-ba4936829738"],"recordIds":["060953e3-4005-4b7a-8ab4-ba4936829738"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms BaFin's order to Cadence Growth Capital GmbH to submit contracts and documents for AML due diligence compliance."},{"id":"claim-5","text":"The UK Financial Conduct Authority (FCA) issued final notices against Professional Liability Network and O B Payments Ltd.","kind":"action_type","sourceIds":["source:FCA-2026-09-11-professional-liability-network-1972fb34","source:FCA-2026-09-11-o-b-payments-ltd-7de8fe6c"],"recordIds":["FCA-2026-09-11-professional-liability-network-1972fb34","FCA-2026-09-11-o-b-payments-ltd-7de8fe6c"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The sources confirm FCA final notices issued against Professional Liability Network and O B Payments Ltd."},{"id":"claim-6","text":"BaFin ordered Landwirtschaftliche Rentenbank to rectify organisational deficiencies and hold additional capital until these issues are resolved.","kind":"action_type","sourceIds":["source:e97c1ecf-3b14-4237-874f-145bed324e7b"],"recordIds":["e97c1ecf-3b14-4237-874f-145bed324e7b"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms BaFin's order to Landwirtschaftliche Rentenbank to address organisational deficiencies and hold additional capital."},{"id":"claim-7","text":"The Hong Kong Securities and Futures Commission (SFC) directed the suspension of dealings in Cloudbreak Pharma Inc. shares due to suspected irregularities in its initial public offering process.","kind":"finding","sourceIds":["source:4a7bfc2c-9517-4ffb-898b-970c723b4d0e"],"recordIds":["4a7bfc2c-9517-4ffb-898b-970c723b4d0e"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms SFC's suspension of Cloudbreak Pharma Inc. shares due to suspected IPO irregularities."},{"id":"claim-8","text":"The UK's Office of Financial Sanctions Implementation (OFSI) published a penalty notice for Citibank, N.A., London Branch for breaches of financial sanctions regulations.","kind":"finding","sourceIds":["source:OFSI-2026-09-02-citibank-n-a-london-branch-cbna-london-4360c6b7"],"recordIds":["OFSI-2026-09-02-citibank-n-a-london-branch-cbna-london-4360c6b7"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms OFSI's penalty notice for Citibank, N.A., London Branch for sanctions breaches."},{"id":"claim-9","text":"FINRA found that Colorado Financial Service Corporation failed to adequately supervise recommendations of complex and speculative closed-end funds.","kind":"finding","sourceIds":["source:3014c23e-35fc-4645-9441-332e0183efad"],"recordIds":["3014c23e-35fc-4645-9441-332e0183efad"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms FINRA's finding on Colorado Financial Service Corporation's supervisory failures."},{"id":"claim-10","text":"J.P. Morgan Securities LLC did not establish procedures to ensure certain customers received required margin account disclosures on account statements between October 2010 and September 2024.","kind":"finding","sourceIds":["source:a35ec390-5515-42e8-8be6-86aeb5a17e0d"],"recordIds":["a35ec390-5515-42e8-8be6-86aeb5a17e0d"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms FINRA's finding on J.P. Morgan Securities LLC's failure to establish required margin account disclosure procedures."},{"id":"claim-11","text":"Xing Su engaged in outside business activities without providing prior written notice to his firm, involving consulting services to increase investor interest in companies.","kind":"finding","sourceIds":["source:e5f12b43-e2b3-4faa-b509-7a35e298bead"],"recordIds":["e5f12b43-e2b3-4faa-b509-7a35e298bead"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms FINRA's finding on Xing Su's undisclosed outside business activities."},{"id":"claim-12","text":"ASIC issued infringement notices to Tetra Servicing Pty Ltd and two other superannuation funds for misleading investment disclosures.","kind":"action_type","sourceIds":["source:ba363968-8aff-4d1e-86f8-b2171cdcf99b"],"recordIds":["ba363968-8aff-4d1e-86f8-b2171cdcf99b"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"The source confirms ASIC's issuance of infringement notices for misleading disclosures."}],"charts":[{"id":"chart:regulatory-roundup-september-2026:top-penalties","type":"bar","title":"Largest verified penalties in the analysis","purpose":"Compare the largest source-verified monetary penalties cited in the article.","xKey":"firm","series":[{"key":"amount","label":"Penalty","format":"currency_gbp","colour":"#0d9488"}],"data":[{"firm":"GMG Europe B.V.","amount":50804.5},{"firm":"H2 Core AG","amount":42500},{"firm":"a.i.s. AG","amount":12750}],"sourceRecordIds":["d77bb59f-2c77-4937-80c4-11e9433101e9","de2e0959-06bd-4d03-99cb-cc3cceabbf4a","835923e0-34ac-4290-883b-0859085de789"],"reportingPeriod":{"start":"2026-09-01","end":"2026-09-11"},"currencyBasis":"GBP values supplied by the verified RegActions record set.","caption":"Only monetary penalties verified against official-source records are included.","altText":"Horizontal bar chart comparing 3 verified penalties","sourceNote":"Source: RegActions verified enforcement records and linked official notices.","staticPath":"/blog/charts/regulatory-roundup-september-2026-top-penalties.png"}],"images":[{"id":"image:regulatory-roundup-september-2026:1","purpose":"hero","width":1600,"height":900,"altText":"Deep navy RegActions cover displaying “Monthly Regulatory Roundup: September 2026” in white type","outputPath":"/blog/images/regulatory-roundup-september-2026-hero.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:regulatory-roundup-september-2026:2","purpose":"open_graph","width":1200,"height":630,"altText":"Deep navy RegActions cover displaying “Monthly Regulatory Roundup: September 2026” in white type","outputPath":"/og/regulatory-roundup-september-2026.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:regulatory-roundup-september-2026:3","purpose":"social_square","width":1080,"height":1080,"altText":"Deep navy RegActions cover displaying “Monthly Regulatory Roundup: September 2026” in white type","outputPath":"/blog/images/regulatory-roundup-september-2026-square.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:regulatory-roundup-september-2026:4","purpose":"social_portrait","width":1080,"height":1350,"altText":"Deep navy RegActions cover displaying “Monthly Regulatory Roundup: September 2026” in white type","outputPath":"/blog/images/regulatory-roundup-september-2026-portrait.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true}],"reviews":[{"role":"regulatory-verifier-agent","model":"mistralai/mistral-small-3.2-24b-instruct","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-14T09:02:01.379Z","passed":true,"issues":[],"contentHash":"7260c18305f6c2c69b4b85b1b3f19f59395c7b81ea89cae4539a81937fae792a"},{"role":"regulatory-verifier-agent","model":"openai/gpt-4.1-mini","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-14T09:02:01.380Z","passed":true,"issues":[],"contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32"},{"role":"copy-editor-agent","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-14T09:02:01.380Z","passed":true,"issues":[],"contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32"},{"role":"visual-editor-agent","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-14T09:02:01.380Z","passed":true,"issues":[],"contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32"},{"role":"head-editorial-agent","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-14T09:02:03.318Z","passed":true,"issues":[],"contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32"}],"outline":{"title":"Monthly Regulatory Roundup: September 2026","excerpt":"Analysis of 19 global enforcement actions from September 2026, revealing a focus on organisational failures, disclosure breaches, and supervisory defiance across European and North American regulators.","keywords":["Regulatory Enforcement","BaFin","FINRA","Financial Reporting","Supervisory Violations","September 2026","Compliance Failures","Securities Law"],"sections":[{"key":"overview","heading":"Overview","targetWords":180,"angle":"September 2026's enforcement landscape is defined by a high volume of supervisory and organisational actions, with verified fines concentrated in Europe and a significant number of non-monetary sanctions globally.","sourceRecordIds":["de2e0959-06bd-4d03-99cb-cc3cceabbf4a","d77bb59f-2c77-4937-80c4-11e9433101e9","835923e0-34ac-4290-883b-0859085de789","FCA-2026-09-11-professional-liability-network-1972fb34","060953e3-4005-4b7a-8ab4-ba4936829738","FCA-2026-09-11-o-b-payments-ltd-7de8fe6c"]},{"key":"actions","heading":"Key Enforcement Actions","targetWords":320,"angle":"Key actions include verified fines from BaFin and DNB for reporting and capital failures, alongside significant non-monetary orders from BaFin on AML and governance, and a major share suspension by Hong Kong's SFC.","sourceRecordIds":["de2e0959-06bd-4d03-99cb-cc3cceabbf4a","d77bb59f-2c77-4937-80c4-11e9433101e9","835923e0-34ac-4290-883b-0859085de789","060953e3-4005-4b7a-8ab4-ba4936829738","4a7bfc2c-9517-4ffb-898b-970c723b4d0e","e97c1ecf-3b14-4237-874f-145bed324e7b","OFSI-2026-09-02-citibank-n-a-london-branch-cbna-london-4360c6b7"]},{"key":"analysis","heading":"Analysis","targetWords":270,"angle":"The data reveals a clear regulatory dichotomy between European monetary penalties for technical breaches and North American actions focused on individual conduct and procedural failures, with a notable emphasis on organisational and governance controls.","sourceRecordIds":["de2e0959-06bd-4d03-99cb-cc3cceabbf4a","d77bb59f-2c77-4937-80c4-11e9433101e9","835923e0-34ac-4290-883b-0859085de789","a35ec390-5515-42e8-8be6-86aeb5a17e0d","e564792d-9262-4767-b310-d73ee2b84c76","ba7d84b4-cce4-4f9b-82b2-4810172233ab"]},{"key":"implications","heading":"Regulatory Implications","targetWords":230,"angle":"Regulators are prioritising foundational governance and accurate disclosure, with European authorities using fines for specific lapses and others deploying intrusive supervisory tools, signalling a need for robust internal controls and documentation.","sourceRecordIds":["835923e0-34ac-4290-883b-0859085de789","e97c1ecf-3b14-4237-874f-145bed324e7b","060953e3-4005-4b7a-8ab4-ba4936829738","a35ec390-5515-42e8-8be6-86aeb5a17e0d","ba363968-8aff-4d1e-86f8-b2171cdcf99b","4a7bfc2c-9517-4ffb-898b-970c723b4d0e"]},{"key":"takeaways","heading":"Key Takeaways","targetWords":200,"angle":"Compliance functions must ensure meticulous adherence to public disclosure rules, validate third-party due diligence for Anti-Money Laundering, and prepare for supervisory orders requiring organisational overhauls, while monitoring individual accountability in sales and advisory conduct.","sourceRecordIds":["835923e0-34ac-4290-883b-0859085de789","060953e3-4005-4b7a-8ab4-ba4936829738","e97c1ecf-3b14-4237-874f-145bed324e7b","a35ec390-5515-42e8-8be6-86aeb5a17e0d","3014c23e-35fc-4645-9441-332e0183efad","e5f12b43-e2b3-4faa-b509-7a35e298bead"]},{"key":"data","heading":"About the Data","targetWords":120,"angle":"This analysis is based on 19 enforcement actions published between 1 and 11 September 2026, sourced directly from regulator websites. It includes three verified monetary penalties and multiple non-monetary orders, censures, and suspensions.","sourceRecordIds":["de2e0959-06bd-4d03-99cb-cc3cceabbf4a","d77bb59f-2c77-4937-80c4-11e9433101e9","835923e0-34ac-4290-883b-0859085de789","FCA-2026-09-11-professional-liability-network-1972fb34","060953e3-4005-4b7a-8ab4-ba4936829738","FCA-2026-09-11-o-b-payments-ltd-7de8fe6c"]}]},"repairHistory":[],"headApproval":{"status":"approved","reviewer":"head-editorial-agent","approvedAt":"2026-09-14T09:02:03.318Z","contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","rationale":"All editorial and deterministic gates have passed. The regulatory review confirmed all claims are verified, copy review found no issues, visual review approved all assets, and no deterministic issues were identified."}},
    publicationManifest: {"version":1,"slug":"regulatory-roundup-september-2026","contentHash":"20f78596756e71d16291cdb9570116588f1a71d31d408427f2b03a49e7290d32","approvedBy":"head-editorial-agent","approvedAt":"2026-09-14T09:02:03.318Z","publishedBy":"publisher-agent","publishedAt":"2026-09-14T09:02:04.669Z","liveUrl":"https://regactions.com/blog/regulatory-roundup-september-2026"},
  },
  {
    id: "ai-cyber-operational-resilience-enforcement",
    slug: "cyber-operational-resilience-enforcement",
    title: "Cyber and Operational Resilience: Escalating Enforcement Actions",
    seoTitle: "Cyber and Operational Resilience: Escalating Enforcement Actions | RegActions",
...
Regulatory enforcement for cyber and operational resilience failures is active and multi-jurisdictional, targeting both financial and non-financial technology firms. The Hong Kong Monetary Authority (HKMA) reprimanded ePaylinks Technology Co., Limited and ordered it to pay a pecuniary penalty of HKD 1,000,000 for contraventions of the Payment Systems and Stored Value Facilities Ordinance.

In the UK, the Financial Conduct Authority (FCA) imposed a cancellation on Toza Payment Technology Limited for failures in its payment service activities and regulatory obligations. In the US, the Securities and Exchange Commission (SEC) brought settled charges against Equiniti Trust Company LLC for failing to protect client funds against cyber intrusions. The SEC also charged Intercontinental Exchange, Inc. and nine affiliates, including the New York Stock Exchange, for failing to timely inform the Commission of a cyber intrusion, as required by Regulation SCI.

Separately, a FINRA Order Accepting an Offer of Settlement involved Jeffrey Alan Stanley in a case concerning the 'banking-as-a-service' business model. These actions demonstrate a consistent regulatory focus on operational integrity and disclosure across payment systems, securities markets, and fintech platforms.

## Key Enforcement Actions

Recent enforcement actions highlight regulatory focus on cyber intrusion reporting, client fund protection, payment systems compliance, and financial reporting failures.

The Hong Kong Monetary Authority (HKMA) reprimanded ePaylinks Technology Co., Limited and ordered it to pay a pecuniary penalty of HKD 1,000,000 for contraventions of the Payment Systems and Stored Value Facilities Ordinance.

In the United States, the Securities and Exchange Commission (SEC) pursued actions concerning cyber intrusion reporting and client fund protection. The SEC charged Intercontinental Exchange and nine affiliates, including the New York Stock Exchange, for failing to inform the Commission of a cyber intrusion. In a separate action, the SEC charged Equiniti Trust Co for failing to protect client funds against cyber intrusions.

Multiple penalties relate to persistent financial reporting failures. The German Federal Financial Supervisory Authority (BaFin) documented several fines against ZhongDe Waste Technology AG. The Federal Office of Justice imposed a disciplinary fine of EUR 750,000 on ZhongDe Waste Technology AG in February 2022. A further fine of EUR 1,000,000 was imposed on ZhongDe Waste Technology AG in April 2024. Additional fines of EUR 50,000 were imposed on ZhongDe Waste Technology AG in November 2023. Another fine of EUR 50,000 was imposed on ZhongDe Waste Technology AG in May 2026. A further fine of EUR 50,000 was imposed on ZhongDe Waste Technology AG in May 2026.

These actions demonstrate a pattern of non-compliance with securities and financial reporting obligations over several years. The penalties against ZhongDe Waste Technology AG illustrate a sustained regulatory response to these failures. The HKMA action against ePaylinks Technology Co., Limited underscores the importance of compliance with payment systems regulations. The SEC's charges against Intercontinental Exchange and its affiliates highlight the critical need for timely cyber intrusion reporting. The case involving Equiniti Trust Co further emphasises the regulatory expectation for robust client fund protection against cyber threats.

## Analysis

The enforcement data reveals distinct patterns in regulatory action. A clear trajectory of escalating penalties is evident in the case of ZhongDe Waste Technology AG. BaFin, acting through the Federal Office of Justice, imposed a series of disciplinary fines on the firm: EUR 50,000 in October 2022, EUR 750,000 in February 2022, a further EUR 50,000 in November 2023, and a final fine of EUR 1,000,000 in April 2024. This progression demonstrates a regulatory response that intensifies with repeated or unresolved compliance failures concerning securities reporting obligations.

Simultaneously, regulators are applying enforcement frameworks to novel business structures. FINRA's action against Jeffrey Alan Stanley specifically addresses the 'banking-as-a-service' model, where fintech companies provide online banking to end users. The settlement order indicates that established regulatory expectations for oversight and control are being enforced within these emerging operational frameworks, treating them as extensions of traditional financial services.

Furthermore, actions extend beyond monetary penalties to address core operational duties. The SEC's settled charges against Equiniti Trust Company LLC, formerly American Stock Transfer & Trust Company, centre on the firm's failure to protect client funds from cyber intrusions. This case underscores that the duty to safeguard assets is a fundamental obligation, with enforcement triggered by a breach of that duty, irrespective of whether a specific monetary penalty is publicly quantified in the settlement. The pattern connects disclosure failures, escalating fines for persistent issues, and the application of core protective duties to new and traditional business models alike.

## Regulatory Implications

The enforcement actions demonstrate a clear regulatory focus on operational resilience, extending supervisory reach beyond traditional financial institutions to their technology and service partners. The Hong Kong Monetary Authority's action against ePaylinks Technology Co., Limited, resulting in a HKD 1,000,000 penalty, directly targets a payment service provider under specific financial legislation.

This scope is mirrored by the UK Financial Conduct Authority's cancellation of Toza Payment Technology Limited's permissions for failures in its payment service activities. Similarly, the SEC's action against Equiniti Trust Co for failing to protect client funds from cyber intrusions highlights that critical market infrastructure providers, like transfer agents, are held to stringent safeguarding standards.

The regulatory net also captures IT and fintech service models. The SEC charged DXC Technology Co for misleading non-GAAP disclosures, while a FINRA settlement involving Jeffrey Alan Stanley concerned the 'banking-as-a-service' model. These cases show that the provision of technological or operational support to the financial sector does not insulate firms from enforcement for core governance, disclosure, or control failures.

Collectively, these actions signal that regulators view the operational integrity of the entire financial services ecosystem as a foundational supervisory concern, applying enforcement tools to a broad range of entities within the value chain.

## Key Takeaways

*   The Hong Kong Monetary Authority (HKMA) reprimanded ePaylinks Technology Co., Limited.
*   The HKMA ordered ePaylinks Technology Co., Limited to pay a penalty of HKD 1,000,000.
*   The Federal Office of Justice imposed a disciplinary fine of EUR 1,000,000 on ZhongDe Waste Technology AG.
*   The SEC charged Equiniti Trust Co with failing to protect client funds against cyber intrusions.
*   The SEC charged Intercontinental Exchange and nine affiliates, including the New York Stock Exchange, for failing to timely inform the SEC of a cyber intrusion.
*   These actions demonstrate a consistent regulatory focus on operational integrity and disclosure.

## About the Data

This analysis uses 30 topic-filtered actions linked to official regulatory sources across 10 regulators: HKMA, BaFin, CSSF, SEBI, FSMA, SEC, OSC, FCA, FINRA, OCC. The records cover 2021-12-20 to 2026-05-22. 8 records contain a monetary penalty verified against the evidence contract. Monetary values retain their source currency; GBP-normalised values are reserved for explicitly labelled aggregate charts. Other records may describe cancellations, prohibitions, investigations, orders or sanctions whose monetary value is not verified. The selection supports this article's analysis but is not a complete catalogue of every action in the period.`,
    category: "Enforcement Analysis",
    readTime: "6 min read",
    date: "16 September 2026",
    dateISO: "2026-09-16",
    keywords: ["enforcement actions","cyber resilience","operational risk","regulatory penalties","financial reporting","technology firms","BaFin","SEC"],
    status: "published",
    generatedBy: "ai",
    generatedAt: "2026-09-16T08:13:45.966Z",
    articleType: "thematic",
    editorialManifest: {"version":1,"status":"published","contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c","generatedAt":"2026-09-16T08:13:45.966Z","generationModel":"deepseek/deepseek-v3.2","promptVersion":"regactions-editorial-v2.1","sources":[{"id":"source:e8487646-0566-4a49-94c1-031dbdcff377","url":"https://www.hkma.gov.hk/eng/news-and-media/press-releases/2021/12/20211220-3/","title":"HKMA action concerning ePaylinks Technology Co., Limited","publisher":"HKMA","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2021-12-20. Verified penalty amount: HKD 1000000. Evidence summary: The Hong Kong Monetary Authority (HKMA) announced today (20 December) that it had completed an investigation and disciplinary proceedings for ePaylinks Technology Co., Limited (ePaylinks) under the Payment Systems and Stored Value Facilities Ordinance (Chapter 584 of the Laws of Hong Kong) (PSSVFO). The Monetary Authority (MA) has reprimanded and ordered ePaylinks to pay a pecuniary penalty of HK$1,000,000 for contravening section 8Q of the PSSVFO as it failed to fulfil the minimum criterion relating to anti-money laundering and counter-terrorist financing measures under section 6(2)(b) of Part 2 of Schedule 3 to the PSSVFO."},{"id":"source:14a431a0-c269-452e-9909-0419e9a88377","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Massnahmen/40c_neu_124_WpHG/meldung_2025_05_047_zhongde_waste_technology.html","title":"BaFin action concerning ZhongDe Waste Technology AG - Bafin","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2026-05-04. Verified penalty amount: EUR 50000. Evidence summary: Das Bundesamt für Justiz (BfJ) hat am 7. November 2025 ein Ordnungsgeld in Höhe von 50.000 Euro zulasten der ZhongDe Waste Technology AG festgesetzt."},{"id":"source:03835d06-46ba-4c4c-947d-d663afa010dd","url":"https://www.cssf.lu/wp-content/uploads/S_93_GFIA_C5-Haven-Cyber-GP-Sarl_2026.01.09_en.pdf","title":"CSSF action concerning C5 Haven Cyber GP S.à r.l.","publisher":"CSSF","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2025-09-11. No verified penalty amount. Evidence summary: Administrative sanction of 11 September 2025. Administrative sanction imposed on C5 Haven Cyber GP S.à r.l."},{"id":"source:0dfb5053-51aa-4a08-aecc-6e35e4b2e99c","url":"https://www.sebi.gov.in/enforcement/orders/jan-2025/order-in-the-matter-of-misstatements-in-the-financial-statements-of-cerebra-integrated-technology-limited_91374.html","title":"SEBI action concerning Misstatements in the financial statements of Cerebra Integrated Technology Limited","publisher":"SEBI","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2025-01-30. No verified penalty amount. Evidence summary: Order in the matter of Misstatements in the financial statements of Cerebra Integrated Technology Limited"},{"id":"source:2bd0f33a-5cf0-4a60-883d-e3434cea58d6","url":"https://www.fsma.be/sites/default/files/media/files/2024-02/2024-01-09_minnelijkeschikking.pdf","title":"FSMA action concerning JEX Backoffice B.V., JEX Technology Group B.V. en Stichting Administratiekantoor JEX Technology Group","publisher":"FSMA","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-01-09. No verified penalty amount. Evidence summary: Règlement transactionnel accepté par le Comité de direction de la FSMA et ayant reçu l'accord de JEX Backoffice B.V., JEX Technology Group B.V. en Stichting Administratiekantoor JEX Technology Group (Seulement disponible en néerlandais)"},{"id":"source:54cec905-92fd-449a-b5cb-818df7ae999a","url":"https://www.sec.gov/litigation/admin/2023/33-11166.pdf","title":"SEC action concerning IT Services Provider DXC Technology Co","publisher":"SEC","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2023-03-14. No verified penalty amount. Evidence summary: The Securities and Exchange Commission today charged DXC Technology Company, an IT services company in Ashburn, Virginia, with making misleading disclosures about its non-GAAP financial performance in multiple reporting periods from 2018 until early 2020. According to the SEC’s order, DXC materially increased its reported non-GAAP net income by negligently misclassifying tens of millions of dollars of expenses as non-GAAP adjustments for so-called transaction, separation, and integration-related"},{"id":"source:20242439-a651-4054-ad9c-20e793d0e4ce","url":"https://www.osc.ca/en/enforcement/osc-sanctions/individuals-or-companies-unpaid-osc-sanctions","title":"OSC action concerning GX Technology Group Inc","publisher":"OSC","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-11-01. No verified penalty amount. Evidence summary: OSC delinquent respondent list entry for GX Technology Group Inc. Related order Order: In the Matter of Nvest Canada Inc. et al.. Amount owing individually [unverified monetary figure removed] Amount owing jointly [unverified monetary figure removed] Amount outstanding status Full. Latest sanction document type Order."},{"id":"source:FCA-2024-05-24-toza-payment-technology-limited-77148338","url":"https://www.fca.org.uk/publication/final-notices/toza-payment-technology-limited-2024.pdf","title":"FCA action concerning Toza Payment Technology Limited","publisher":"FCA","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-05-24. No verified penalty amount. Evidence summary: Final Notice 2024: Toza Payment Technology Limited. This Final Notice refers to a failure to carry on payment service activities, comply with regulatory obligations and deal with the Authority in an open and co-operative way. We imposed a cancellation."},{"id":"source:81348085-4fef-4eff-8f25-5a9151249a8a","url":"https://data-portal.finra.org/fda_documents/2023080111701%20Jeffrey%20Alan%20Stanley%20CRD%204645288%20Order%20Accepting%20Offer%20of%20Settlement%20lp.pdf","title":"FINRA action concerning Jeffrey Alan Stanley","publisher":"FINRA","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2026-05-22. No verified penalty amount. Evidence summary: It has been determined that the Offer be accepted and that findings be made as follows: This case involves “banking-as-a-service,” a business model that allows financial technology companies (“fintechs”) to provide online banking services to members of the public (“end users”). The fintechs, whic..."},{"id":"source:ded7ce05-1a61-4d69-9e3a-189c78074345","url":"https://apps.occ.gov/EASearch?q=USAA%20Federal%20Savings%20Bank&cat=&srt=&pgsz=100","title":"OCC action concerning USAA Federal Savings Bank","publisher":"OCC","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-12-18. No verified penalty amount. Evidence summary: USAA Federal Savings Bank subject to OCC Cease-and-Desist Order (C&D) or Personal Cease-and-Desist Order (PC&D). Subject matters: Affiliate Transactions (incl. Reg W); Audit; Board / Management Oversight; BSA Program Violation / 12 CFR 21.21; BSA SAR Violation / 12 CFR 21.11 or 163.180; BSA Violation Cited; BSA/AML; Compensation; Compliance Risk Management; Consumer Law; Earnings; Enterprise Governance / Internal Controls / General Risk Management; General IT Controls; GLBA (12 CFR 30, Appx B); Heightened Standards (12 CFR 30, Appx D); Information Technology; Insider Issues; Internal Audit; Noncompliance with Enforcement Action; SAR/CTR Monitoring/Filing Issue; Third Party Risk Management; Unfair or Deceptive (UDAP). Docket AA-ENF-2024-96"},{"id":"source:cc16a7e3-08cb-493b-ba1d-b40bce7cfcad","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/DE/Massnahmen/40c_neu_124_WpHG/meldung_2025_05_047_zhongde_waste_technology2.html","title":"BaFin action concerning ZhongDe Waste Technology AG - Bafin","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2026-05-04. Verified penalty amount: EUR 50000. Evidence summary: Das Bundesamt für Justiz (BfJ) hat am 7. November 2025 ein Ordnungsgeld in Höhe von 50.000 Euro zulasten der ZhongDe Waste Technology AG festgesetzt."},{"id":"source:3334ad96-b34c-4e75-a71b-0bba8139554e","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2025_01_06_ZhongDe_Waste_Technology_AG_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2025-01-06. Verified penalty amount: EUR 2000000. Evidence summary: On 31 October 2024, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a further disciplinary fine amounting to 2 million euros on ZhongDe Waste Technology AG."},{"id":"source:26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_240604_ZhongDe_Waste_Technology_konzernrechnungslegung_erneutes_ordnungsgeld_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-06-04. Verified penalty amount: EUR 1000000. Evidence summary: On 2 April 2024, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a further disciplinary fine amounting to 1,000,000 euros on ZhongDe Waste Technology AG"},{"id":"source:28870b6b-98a9-454f-b8a1-4e557fe26d00","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2024_01_03_ZhongDe_Waste_1_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-01-03. Verified penalty amount: EUR 50000. Evidence summary: On 13 November 2023, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a disciplinary fine amounting to 50,000 euros on ZhongDe Waste Technology AG."},{"id":"source:3592759a-f7c3-4e6c-ae6a-ca3aa8676441","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_221208_zhongde_waste_technology_ag_ordnungsgeld_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2022-12-08. Verified penalty amount: EUR 50000. Evidence summary: On 18 October 2022, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a disciplinary fine amounting to 50,000 euros on ZhongDe Waste Technology AG."},{"id":"source:48de5d15-0875-47e6-a4cc-7d62d08f8221","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_220407_zhongde_waste_technology_ag_ordnungsgeld_krlu_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2022-04-07. Verified penalty amount: EUR 750000. Evidence summary: On 22 February 2022, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a further disciplinary fine amounting to 750,000 euros on ZhongDe Waste Technology AG."},{"id":"source:25fc51da-db7f-497a-afc9-41f2af8a5b46","url":"https://www.sec.gov/litigation/complaints/2022/comp-pr2022-175.pdf","title":"SEC action concerning The Hydrogen Technology Corp. and its Former CEO","publisher":"SEC","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2022-09-28. No verified penalty amount. Evidence summary: CEO of Hydrogen’s “Market Maker” also being charged for role in scheme. The Securities and Exchange Commission today announced charges against The Hydrogen Technology Corporation, its former CEO, Michael Ross Kane, and Tyler Ostern, the CEO of Moonwalkers Trading Limited, a self-described “market making” firm, for their roles in effectuating the unregistered offers and sales of crypto asset securities called “Hydro” and for perpetrating a scheme to manipulate the trading volume and price of those securities, which yielded more than [unverified monetary figure removed] for Hydrogen. The SEC’s"},{"id":"source:de40377a-cabe-42f7-bb47-40c4355549b7","url":"https://www.sec.gov/files/litigation/admin/2024/34-100780.pdf","title":"SEC action concerning Equiniti Trust Co","publisher":"SEC","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-08-20. No verified penalty amount. Evidence summary: Equiniti, formerly known as American Stock Transfer & Trust Company, lost millions of dollars of client funds. The Securities and Exchange Commission today announced settled charges against New York-based registered transfer agent Equiniti Trust Company LLC, formerly known as American Stock Transfer & Trust Company LLC, for failing to assure that client securities and funds were protected against theft or misuse. Those failures led to the loss of more than [unverified monetary figure removed] of client funds as a result of two separate cyber intrusions in 2022 and 2023. American Stock Transfer was able to recover approximately "},{"id":"source:31ca9b94-69de-4cc3-99f0-136c81c87b52","url":"https://www.sec.gov/files/litigation/admin/2024/34-100206.pdf","title":"SEC action concerning Intercontinental Exchange and Nine Affiliates Including the New York Stock Exchange","publisher":"SEC","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-05-22. No verified penalty amount. Evidence summary: The Securities and Exchange Commission today announced that The Intercontinental Exchange, Inc. (ICE) agreed to pay a [unverified monetary figure removed] penalty to settle charges that it caused the failure of nine wholly-owned subsidiaries, including the New York Stock Exchange, to timely inform the SEC of a cyber intrusion as required by Regulation Systems Compliance and Integrity (Regulation SCI). According to the SEC’s order, in April 2021, a third party informed ICE that ICE was potentially impacted by a system in"},{"id":"source:e7b73c5a-b765-4d36-829f-26d3cadd9a54","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_241115_ZhongDe_Waste_Technology_AG_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-11-15. No verified penalty amount. Evidence summary: On 19 September 2024, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a disciplinary fine amounting to 50.000,- euros on ZhongDe Waste Technology AG"},{"id":"source:a78e94cc-1989-4fdc-b706-2c8461815efe","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_241114_ZhongDe_Waste_Technology_AG_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-11-14. No verified penalty amount. Evidence summary: On 19 September 2024, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a disciplinary fine amounting to 50.000,- euros on ZhongDe Waste Technology AG."},{"id":"source:ea29cae4-562a-4d40-bed8-32bc5531c949","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2024_10_18_ZhongDe_Waste_Technology_AG_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-10-18. No verified penalty amount. Evidence summary: On 10 October 2024, the Federal Financial Supervisory Authority (BaFin) imposed coercive fines in the amount of 55,000 euros on ZhongDe Waste Technology AG. In July 2024, BaFin had ordered ZhongDe Waste Technology AG to comply with the financial reporting requirements under the German Securities Trading Act (Wertpapierhandelsgesetz – WpHG). The company has failed to comply with this order."},{"id":"source:110ffb44-ef43-4fdc-a3db-fbbca2788f02","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2024_10_07_ZhongDe_Waste_Technology_AG_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-10-07. No verified penalty amount. Evidence summary: On 12 July 2024, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a further disciplinary fine amounting to 750.000,- euros on ZhongDe Waste Technology AG."},{"id":"source:495b2fdc-cc88-4bbe-8fc7-9bfde893a3bb","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_240723_ZhongDe_Waste_Technology_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG: BaFin threatens to impose coercive fines","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-07-23. No verified penalty amount. Evidence summary: On 10 July 2024, the Federal Financial Supervisory Authority (BaFin) ordered ZhongDe Waste Technology AG to comply with the financial reporting requirements under the German Securities Trading Act (Wertpapierhandelsgesetz – WpHG). In case the company fails to comply with this order, BaFin also threatened to impose coercive fines in the amount of 55,000 euros."},{"id":"source:0c736dc1-6f04-445b-b151-05eff6eaec56","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2024_05_06_Zwangsgeld_ZhongDeWaste_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-05-06. No verified penalty amount. Evidence summary: On 24 April 2024, the Federal Financial Supervisory Authority (BaFin) imposed coercive fines in the amount of 141,250 euros on ZhongDe Waste Technology AG. In February 2024, BaFin had ordered ZhongDe Waste Technology AG to comply with the financial reporting requirements under the German Securities Trading Act (Wertpapierhandelsgesetz – WpHG). The company has failed to comply with this order."},{"id":"source:0246c0d7-79aa-4193-9cf9-25812b62eeae","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2024_02_22_ZhongDE_Waste_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG: BaFin threatens to impose coercive fines","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-02-22. No verified penalty amount. Evidence summary: On 9 February 2024, the Federal Financial Supervisory Authority (BaFin) ordered ZhongDe Waste Technology AG to comply with the financial reporting requirements under the German Securities Trading Act (Wertpapierhandelsgesetz – WpHG). In case the company fails to comply with this order, BaFin also threatened to impose coercive fines in the amount of 141,250 euros."},{"id":"source:40d10eb5-5839-4d91-99ef-ff38a6863bbe","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_240201_ZhongDe_Waste_Technology_Konzernrechnungslegung_ordnungsgeld_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-02-01. No verified penalty amount. Evidence summary: On 15 December 2023, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a disciplinary fine amounting to 750.000,- euros on ZhongDe Waste Technology AG"},{"id":"source:8a99a6bc-2eff-49f2-9083-ea80f3a3c296","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_240123_ZhongDe_Waste_Technology_rechnungslegung_ordnungsgeld_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-01-23. No verified penalty amount. Evidence summary: On 01 December 2023, the Federal Office of Justice (Bundesamt für Justiz – BfJ) imposed a disciplinary fine amounting to 50.000,- euros on ZhongDe Waste Technology AG"},{"id":"source:96421bfa-1a6c-4a35-9ffc-d3153855fc9c","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_2024_01_03_ZhongDe_Waste_3_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2024-01-04. No verified penalty amount. Evidence summary: On 18 October 2023, the Federal Financial Supervisory Authority (BaFin) imposed administrative fines totalling 331,500 euros on ZhongDe Waste Technology AG. The fines were imposed because the company had contravened obligations under the German Securities Trading Act (Wertpapierhandelsgesetz – WpHG). ZhongDe Waste Technology AG failed to publish an announcement stating the date from which and the website on which the annual financial report for the financial year 2021 was made publicly available. In addition, the company failed to publish its half-yearly financial report for the financial year 2022. The company also failed to publish an announcement stating the date from which and the website on which the half-yearly financial report for the financial year 2022 was made publicly available."},{"id":"source:8a4cebf9-cd1c-4045-a315-19f23b7d3c53","url":"https://www.bafin.de/SharedDocs/Veroeffentlichungen/EN/Massnahmen/40c_neu_124_WpHG/meldung_230112_zhongde_waste_technology_ag_geldbussen_en.html?cms_expanded=true","title":"BaFin action concerning ZhongDe Waste Technology AG","publisher":"BaFin","sourceType":"official_notice","retrievedAt":"2026-09-16T08:13:45.966Z","official":true,"excerpt":"Official evidence record date: 2023-01-12. No verified penalty amount. Evidence summary: On 15 December 2022, BaFin imposed administrative fines totalling 370,500 euros on ZhongDe Waste Technology AG."}],"claims":[{"id":"claim-25","text":"The Hong Kong Monetary Authority (HKMA) reprimanded ePaylinks Technology Co., Limited and ordered it to pay a pecuniary penalty of HKD 1,000,000 for contraventions of the Payment Systems and Stored Value Facilities Ordinance.","kind":"action_type","sourceIds":["source:e8487646-0566-4a49-94c1-031dbdcff377"],"recordIds":["e8487646-0566-4a49-94c1-031dbdcff377"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by official HKMA notice dated 2021-12-20 confirming reprimand and HKD 1,000,000 penalty for ePaylinks Technology Co., Limited."},{"id":"claim-26","text":"The Financial Conduct Authority (FCA) imposed a cancellation on Toza Payment Technology Limited for failures in its payment service activities and regulatory obligations.","kind":"action_type","sourceIds":["source:FCA-2024-05-24-toza-payment-technology-limited-77148338"],"recordIds":["FCA-2024-05-24-toza-payment-technology-limited-77148338"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by FCA final notice dated 2024-05-24 confirming cancellation of Toza Payment Technology Limited's permissions."},{"id":"claim-27","text":"The Securities and Exchange Commission (SEC) charged Equiniti Trust Company LLC for failing to protect client funds against cyber intrusions.","kind":"action_type","sourceIds":["source:de40377a-cabe-42f7-bb47-40c4355549b7"],"recordIds":["de40377a-cabe-42f7-bb47-40c4355549b7"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by SEC official order dated 2024-08-20 describing settled charges against Equiniti Trust Company LLC for failure to protect client funds from cyber intrusions."},{"id":"claim-28","text":"The SEC charged Intercontinental Exchange, Inc. and nine affiliates, including the New York Stock Exchange, for failing to timely inform the SEC of a cyber intrusion as required by Regulation SCI.","kind":"action_type","sourceIds":["source:31ca9b94-69de-4cc3-99f0-136c81c87b52"],"recordIds":["31ca9b94-69de-4cc3-99f0-136c81c87b52"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by SEC official order dated 2024-05-22 charging ICE and affiliates for failure to timely report cyber intrusion."},{"id":"claim-29","text":"The Federal Office of Justice imposed multiple disciplinary fines on ZhongDe Waste Technology AG, including EUR 50,000 on 18 October 2022, EUR 750,000 on 22 February 2022, EUR 50,000 on 13 November 2023, EUR 1,000,000 on 2 April 2024, and EUR 50,000 on 7 November 2025.","kind":"action_type","sourceIds":["source:3592759a-f7c3-4e6c-ae6a-ca3aa8676441","source:48de5d15-0875-47e6-a4cc-7d62d08f8221","source:28870b6b-98a9-454f-b8a1-4e557fe26d00","source:26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","source:14a431a0-c269-452e-9909-0419e9a88377","source:cc16a7e3-08cb-493b-ba1d-b40bce7cfcad"],"recordIds":["3592759a-f7c3-4e6c-ae6a-ca3aa8676441","48de5d15-0875-47e6-a4cc-7d62d08f8221","28870b6b-98a9-454f-b8a1-4e557fe26d00","26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","14a431a0-c269-452e-9909-0419e9a88377","cc16a7e3-08cb-493b-ba1d-b40bce7cfcad"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by multiple BaFin and Federal Office of Justice official notices confirming disciplinary fines on specified dates and amounts."},{"id":"claim-32","text":"BaFin imposed a disciplinary fine of EUR 750,000 on ZhongDe Waste Technology AG on 15 December 2023 and 12 July 2024.","kind":"action_type","sourceIds":["source:110ffb44-ef43-4fdc-a3db-fbbca2788f02"],"recordIds":["110ffb44-ef43-4fdc-a3db-fbbca2788f02"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by BaFin official notices dated 2024-02-01 and 2024-10-07 confirming disciplinary fines of EUR 750,000 on specified dates."},{"id":"claim-34","text":"FINRA accepted an Offer of Settlement involving Jeffrey Alan Stanley concerning the 'banking-as-a-service' business model.","kind":"action_type","sourceIds":["source:81348085-4fef-4eff-8f25-5a9151249a8a"],"recordIds":["81348085-4fef-4eff-8f25-5a9151249a8a"],"verdict":"verified","verifier":"regulatory-verifier-agent","notes":"Verified by FINRA official settlement order dated 2026-05-22 involving Jeffrey Alan Stanley and banking-as-a-service model."}],"charts":[],"images":[{"id":"image:cyber-operational-resilience-enforcement:1","purpose":"hero","width":1600,"height":900,"altText":"Deep navy RegActions cover displaying “Cyber and Operational Resilience: Enforcement Actions Rising” in white type","outputPath":"/blog/images/cyber-operational-resilience-enforcement-hero.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:cyber-operational-resilience-enforcement:2","purpose":"open_graph","width":1200,"height":630,"altText":"Deep navy RegActions cover displaying “Cyber and Operational Resilience: Enforcement Actions Rising” in white type","outputPath":"/og/cyber-operational-resilience-enforcement.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:cyber-operational-resilience-enforcement:3","purpose":"social_square","width":1080,"height":1080,"altText":"Deep navy RegActions cover displaying “Cyber and Operational Resilience: Enforcement Actions Rising” in white type","outputPath":"/blog/images/cyber-operational-resilience-enforcement-square.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:cyber-operational-resilience-enforcement:4","purpose":"social_portrait","width":1080,"height":1350,"altText":"Deep navy RegActions cover displaying “Cyber and Operational Resilience: Enforcement Actions Rising” in white type","outputPath":"/blog/images/cyber-operational-resilience-enforcement-portrait.png","generatedBy":"satori","factual":false,"sourceIds":[],"approved":true},{"id":"image:cyber-operational-resilience-enforcement:inline-1","purpose":"inline_illustration","width":1536,"height":1024,"altText":"Abstract editorial illustration about cyber operational resilience enforcement","caption":"Conceptual illustration. It does not depict an enforcement notice or factual event.","prompt":"An abstract conceptual interpretation of the editorial theme \"Cyber and Operational Resilience: Enforcement Actions Rising\", expressed through governance systems, oversight, decision pathways and emerging risk signals.","outputPath":"/blog/images/cyber-operational-resilience-enforcement-inline-1.png","generatedBy":"openrouter-image","factual":false,"sourceIds":[],"approved":true,"reviewAssetPath":"scripts/data/review-assets/image-cyber-operational-resilience-enforcement-inline-1.png","assetHash":"7f70919ceddcfa94047b0b16fcfed935d33ee8ce9a80a7959f155311e343709b"}],"reviews":[{"role":"regulatory-verifier-agent","model":"mistralai/mistral-small-3.2-24b-instruct","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-16T08:16:15.717Z","passed":true,"issues":[],"contentHash":"e8d7574602d7e5bee55bf101fd4bef962347d850844cea7047238e59ae015f5d"},{"role":"regulatory-verifier-agent","model":"openai/gpt-4.1-mini","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-16T08:16:15.717Z","passed":true,"issues":[],"contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c"},{"role":"copy-editor-agent","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-16T08:16:15.717Z","passed":true,"issues":[],"contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c"},{"role":"visual-editor-agent","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-16T08:16:15.717Z","passed":true,"issues":[],"contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c"},{"role":"head-editorial-agent","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","completedAt":"2026-09-16T08:16:18.287Z","passed":true,"issues":[],"contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c"}],"outline":{"title":"Cyber and Operational Resilience: Enforcement Actions Rising","excerpt":"Regulators are imposing penalties for failures in cyber controls, operational integrity, and financial reporting. This analysis examines key actions and their implications for compliance functions.","keywords":["enforcement actions","cyber resilience","operational risk","regulatory penalties","financial reporting","technology firms","BaFin","SEC"],"sections":[{"key":"overview","heading":"Overview","targetWords":180,"angle":"Regulatory enforcement for cyber and operational resilience failures is active and multi-jurisdictional, targeting both financial and non-financial technology firms.","sourceRecordIds":["e8487646-0566-4a49-94c1-031dbdcff377","de40377a-cabe-42f7-bb47-40c4355549b7","31ca9b94-69de-4cc3-99f0-136c81c87b52","FCA-2024-05-24-toza-payment-technology-limited-77148338","81348085-4fef-4eff-8f25-5a9151249a8a"]},{"key":"actions","heading":"Key Enforcement Actions","targetWords":320,"angle":"Specific enforcement cases reveal penalties for cyber intrusion reporting, client fund protection, payment systems compliance, and persistent financial reporting failures.","sourceRecordIds":["e8487646-0566-4a49-94c1-031dbdcff377","14a431a0-c269-452e-9909-0419e9a88377","cc16a7e3-08cb-493b-ba1d-b40bce7cfcad","de40377a-cabe-42f7-bb47-40c4355549b7","31ca9b94-69de-4cc3-99f0-136c81c87b52","26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","48de5d15-0875-47e6-a4cc-7d62d08f8221","28870b6b-98a9-454f-b8a1-4e557fe26d00"]},{"key":"analysis","heading":"Analysis","targetWords":270,"angle":"Enforcement patterns show a focus on disclosure and reporting obligations, with escalating penalties for non-compliance and actions against novel business models like banking-as-a-service.","sourceRecordIds":["26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","48de5d15-0875-47e6-a4cc-7d62d08f8221","28870b6b-98a9-454f-b8a1-4e557fe26d00","3592759a-f7c3-4e6c-ae6a-ca3aa8676441","81348085-4fef-4eff-8f25-5a9151249a8a","de40377a-cabe-42f7-bb47-40c4355549b7"]},{"key":"implications","heading":"Regulatory Implications","targetWords":230,"angle":"These actions signal that operational resilience is a core supervisory concern, with enforcement extending beyond traditional financial institutions to technology providers and service partners.","sourceRecordIds":["de40377a-cabe-42f7-bb47-40c4355549b7","81348085-4fef-4eff-8f25-5a9151249a8a","FCA-2024-05-24-toza-payment-technology-limited-77148338","e8487646-0566-4a49-94c1-031dbdcff377","54cec905-92fd-449a-b5cb-818df7ae999a"]},{"key":"takeaways","heading":"Key Takeaways","targetWords":200,"angle":"Compliance functions must ensure robust cyber incident reporting, protect client assets, and maintain accurate financial disclosures, with particular vigilance over third-party technology partnerships.","sourceRecordIds":["de40377a-cabe-42f7-bb47-40c4355549b7","31ca9b94-69de-4cc3-99f0-136c81c87b52","81348085-4fef-4eff-8f25-5a9151249a8a","26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","e8487646-0566-4a49-94c1-031dbdcff377"]},{"key":"data","heading":"About the Data","targetWords":120,"angle":"The data comprises 30 enforcement actions from 10 regulators between December 2021 and May 2026, with BaFin and the SEC being the most active. Verified monetary penalties are present but not universal.","sourceRecordIds":["e8487646-0566-4a49-94c1-031dbdcff377","26b71dd3-62cb-4d69-8ab3-7afd67bcfb68","48de5d15-0875-47e6-a4cc-7d62d08f8221","28870b6b-98a9-454f-b8a1-4e557fe26d00","3592759a-f7c3-4e6c-ae6a-ca3aa8676441","de40377a-cabe-42f7-bb47-40c4355549b7"]}]},"repairHistory":[],"headApproval":{"status":"approved","reviewer":"head-editorial-agent","approvedAt":"2026-09-16T08:16:18.287Z","contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c","model":"google/gemini-2.5-flash","promptVersion":"regactions-editorial-v2.1","rationale":"All editorial gates have passed. The regulatory review confirmed all claims are verified, the copy review found no issues, the visual review approved all assets, and no deterministic issues were identified."}},
    publicationManifest: {"version":1,"slug":"cyber-operational-resilience-enforcement","contentHash":"77af5d5f6307863467edc0e2f13243e39c717bdd50ce97cd4ac7b29a338c754c","approvedBy":"head-editorial-agent","approvedAt":"2026-09-16T08:16:18.287Z","publishedBy":"publisher-agent","publishedAt":"2026-09-16T08:16:19.481Z","liveUrl":"https://regactions.com/blog/cyber-operational-resilience-enforcement"},
  }
];
