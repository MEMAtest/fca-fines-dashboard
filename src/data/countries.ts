...
export const COUNTRIES: Country[] = [
  ...
  c("CD", "COD", "Democratic Republic of the Congo", "Africa", "Central Africa", { aliases: ["Congo, Dem. Rep.", "Democratic Republic of Congo", "DR Congo", "DRC"] }),
  ...
  c("BZ", "BLZ", "Belize", "Americas", "Central America"),
  ...
  c("DM", "DMA", "Dominica", "Americas", "Caribbean"),
  ...
  c("GD", "GRD", "Grenada", "Americas", "Caribbean"),
  ...
  c("KN", "KNA", "Saint Kitts and Nevis", "Americas", "Caribbean"),
  c("LC", "LCA", "Saint Lucia", "Americas", "Caribbean"),
  c("VC", "VCT", "Saint Vincent and the Grenadines", "Americas", "Caribbean"),
  ...
  c("CN", "CHN", "China", "Asia Pacific", "East Asia", { aliases: ["China (People's Republic of)", "China (People’s Republic of)"] }),
  c("CK", "COK", "Cook Islands", "Asia Pacific", "Oceania", { unMember: false, parent: "NZ" }),
  ...
  c("KR", "KOR", "South Korea", "Asia Pacific", "East Asia", { aliases: ["Korea", "Korea, South", "Korea, Rep.", "Republic of Korea"] }),
  c("KG", "KGZ", "Kyrgyzstan", "Asia Pacific", "Central Asia", { aliases: ["Kyrgyz Republic"] }),
  c("LA", "LAO", "Laos", "Asia Pacific", "Southeast Asia", { aliases: ["Lao PDR", "Lao People's Democratic Republic", "Lao People’s Democratic Republic"] }),
  c("MY", "MYS", "Malaysia", "Asia Pacific", "Southeast Asia"),
  c("MV", "MDV", "Maldives", "Asia Pacific", "South Asia"),
  c("MH", "MHL", "Marshall Islands", "Asia Pacific", "Oceania"),
  ...
  c("NR", "NRU", "Nauru", "Asia Pacific", "Oceania"),
  c("NZ", "NZL", "New Zealand", "Asia Pacific", "Oceania"),
  c("NU", "NIU", "Niue", "Asia Pacific", "Oceania", { unMember: false, parent: "NZ" }),
  c("PK", "PAK", "Pakistan", "Asia Pacific", "South Asia"),
  c("PW", "PLW", "Palau", "Asia Pacific", "Oceania"),
  ...
  c("SB", "SLB", "Solomon Islands", "Asia Pacific", "Oceania"),
  ...
  c("TO", "TON", "Tonga", "Asia Pacific", "Oceania"),
  ...
  c("HK", "HKG", "Hong Kong", "Asia Pacific", "East Asia", { unMember: false, parent: "CN", aliases: ["Hong Kong (China)", "Hong Kong SAR, China"] }),
  c("MO", "MAC", "Macau", "Asia Pacific", "East Asia", { unMember: false, parent: "CN", aliases: ["Macau (China)", "Macao", "Macao SAR, China"] }),

  // ── Europe ────────────────────────────────────────────────────────────────
  c("AL", "ALB", "Albania", "Europe", "Southern Europe"),
  c("AD", "AND", "Andorra", "Europe", "Southern Europe"),
  c("AM", "ARM", "Armenia", "Europe", "Eastern Europe"),
  c("AT", "AUT", "Austria", "Europe", "Western Europe"),
  c("AZ", "AZE", "Azerbaijan", "Europe", "Eastern Europe"),
  ...
  c("GE", "GEO", "Georgia", "Europe", "Eastern Europe"),
  ...
  c("GG", "GGY", "Guernsey", "Offshore / IFC", "Crown Dependency", { unMember: false, parent: "GB", aliases: ["Bailiwick of Guernsey"] }),
  ...
  c("VG", "VGB", "British Virgin Islands", "Offshore / IFC", "British Overseas Territory", { unMember: false, parent: "GB", aliases: ["Virgin Islands, British", "Virgin Islands (UK)", "Virgin Islands UK"] }),
  c("TC", "TCA", "Turks and Caicos Islands", "Offshore / IFC", "British Overseas Territory", { unMember: false, parent: "GB" }),
  c("AI", "AIA", "Anguilla", "Offshore / IFC", "British Overseas Territory", { unMember: false, parent: "GB" }),
  c("MS", "MSR", "Montserrat", "Offshore / IFC", "British Overseas Territory", { unMember: false, parent: "GB" }),
  c("VI", "VIR", "US Virgin Islands", "Offshore / IFC", "US Caribbean Territory", { unMember: false, parent: "US", aliases: ["Virgin Islands, U.S.", "Virgin Islands (US)", "United States Virgin Islands", "US Virgin Islands"] }),
  c("AS", "ASM", "American Samoa", "Offshore / IFC", "US Pacific Territory", { unMember: false, parent: "US" }),
  c("GU", "GUM", "Guam", "Offshore / IFC", "US Pacific Territory", { unMember: false, parent: "US" }),
  c("AW", "ABW", "Aruba", "Offshore / IFC", "Dutch Caribbean", { unMember: false, parent: "NL" }),
  c("CW", "CUW", "Curaçao", "Offshore / IFC", "Dutch Caribbean", { unMember: false, parent: "NL", aliases: ["Curacao"] }),
  c("SX", "SXM", "Sint Maarten", "Offshore / IFC", "Dutch Caribbean", { unMember: false, parent: "NL" }),
