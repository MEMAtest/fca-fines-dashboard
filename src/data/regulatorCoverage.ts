...
const LOW_FREQUENCY_REGULATOR_SET = new Set(["AMMC", "GFSC", "IOMFSA", "HKMA"]);
...
const REGULATOR_COVERAGE_SEED: Record<string, RegulatorCoverageSeed> = {
  ...
  FSCA: {
    ...
    years: "Pending",
    count: 0,
    dataQuality: "Official full-archive export loader implemented; promotion pending production gates",
    note: "Official FSCA full-workbook enforcement export and case-document loader is implemented. Promotion remains pipeline until production load and two clean scheduled runs are evidenced.",
    earliestYear: 0,
    latestYear: 0,
    nativeCurrency: "ZAR",
    defaultCurrency: "GBP",
  ...
  CBN: {
    ...
    count: 0,
    dataQuality: "Validated",
    note: "Official CBN notices JSON ingestion is implemented and filters licence, sanction, penalty, and closure notices. Promotion remains pipeline until a non-zero reconciled production load and two clean scheduled runs are evidenced.",
    earliestYear: 0,
    latestYear: 0,
    nativeCurrency: "NGN",
    defaultCurrency: "EUR",
  ...
  NGSEC: {
    ...
    count: 0,
    dataQuality: "Official archive loader implemented; promotion pending gates",
    note: "NGSEC is tracked separately from the US SEC. The official enforcement archive loader covers enforcement updates, referred cases, company actions, APC matters, and litigation pages; promotion requires a non-zero reconciled production load and two clean scheduled runs.",
    earliestYear: 0,
    latestYear: 0,
    nativeCurrency: "NGN",
    defaultCurrency: "GBP",
