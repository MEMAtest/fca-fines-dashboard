...
const REGULATOR_COVERAGE_SEED: Record<string, RegulatorCoverageSeed> = {
  ...
  GHSEC: {
    ...
    note: "Ingested live from the official suspension/revocation/cessation licence tables (65 licence actions, 2019-2022). These are licence enforcement actions rather than monetary penalties, so amounts are null by nature.",
    earliestYear: 2019,
    latestYear: 2022,
    nativeCurrency: "GHS",
    defaultCurrency: "GBP",
  ...
  FSS: {
    ...
    note: "Ingested live from the FSS English press-release board filtered to the 'Supervision-Examination' category (39 supervisory/enforcement press releases, 1998-2022; paginated). English press-release titles are preserved verbatim. FSS press releases seldom state a monetary figure in English, so amounts are null by nature. Distinct from the FSC Korea (fsc.go.kr) source.",
    earliestYear: 1998,
    latestYear: 2022,
    nativeCurrency: "KRW",
    defaultCurrency: "EUR",
