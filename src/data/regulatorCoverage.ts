...
const REGULATOR_COVERAGE_SEED: Record<string, RegulatorCoverageSeed> = {
  ...
  HKMA: {
    ...
    dataQuality: "100%",
    note:
      "Official HKMA enforcement press-release coverage via the HKMA public API with detail-page enrichment.",
    earliestYear: 2007,
    latestYear: 2025,
    nativeCurrency: "HKD",
    defaultCurrency: "GBP",
  ...
  MAS: {
    ...
    dataQuality: "100%",
    note:
      "Official MAS enforcement releases distributed via the Singapore Government Press Centre, with attached notice PDFs used where available.",
    earliestYear: 2023,
    latestYear: 2026,
    nativeCurrency: "SGD",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        url: "https://www.finma.ch/en/documentation/enforcement-reporting/selected-finma-rulings/",
        description:
          "Official FINMA enforcement reporting and selected rulings archive.",
      },
    ],
  },
  SESC: {
