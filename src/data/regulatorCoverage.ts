...
const LOW_CONFIDENCE_LIVE_REGULATOR_SET = new Set([
  ...
  "MFSA",
  "AUSTRAC",
  // DNB's public RSS endpoint is Akamai-protected for unattended clients;
  // retain stored records but run source checks in the fragile lane.
  "DNB",
  // Browser-rendered feeds (WAF / Salesforce Lightning) run in the fragile lane.
  "IOMFSA",
  "FDIC",
]);
...
const REGULATOR_COVERAGE_SEED: Record<string, RegulatorCoverageSeed> = {
  ...
  AFM: {
    ...
    years: "2025-2026",
    count: 7,
    dataQuality: "Live official loader",
    note: "Current official-source enforcement coverage through 2026.",
    earliestYear: 2023,
    latestYear: 2024,
    nativeCurrency: "EUR",
    defaultCurrency: "EUR",
  ...
  DNB: {
    ...
    years: "2023-2026",
    count: 48,
    dataQuality: "Live official sitemap loader",
    note: "Official English enforcement pages are discovered through DNB's public sitemap because its legacy RSS endpoint blocks unattended clients.",
    earliestYear: 2023,
    latestYear: 2026,
    nativeCurrency: "EUR",
    defaultCurrency: "EUR",
  ...
  FSRA: {
    ...
    years: "2025-2026",
    count: 10,
    dataQuality: "Official archive checked daily",
    note: "The official regulatory-actions archive is checked daily. FSRA enforcement publication is intermittent, so freshness is assessed against a 365-day source-contract window.",
    earliestYear: 2025,
    latestYear: 2026,
    nativeCurrency: "USD",
    defaultCurrency: "GBP",
  ...
  JFSC: {
    ...
    years: "2019-2025",
    count: 6,
    dataQuality: "Verified official archive manifest",
    note: "The JFSC site is challenge-protected for datacentre traffic. A verified official civil-penalty manifest preserves dependable coverage while new official publications are reviewed through the sparse-source process.",
    earliestYear: 2019,
    latestYear: 2025,
    nativeCurrency: "GBP",
    defaultCurrency: "GBP",
  ...
  TWFSC: {
    ...
    years: "2012-2026",
    count: 924,
    dataQuality: "Live official sanction feed",
    note: "Ingested live from the FSC Securities and Futures Bureau administrative-sanction feed (929 sanctions scraped, 2012-2026; 813 carry a parsed NT$ fine amount pulled from each detail page; deduplicated to the canonical evidence set for publication). Detail-page amount extraction is keyword-anchored to the fine itself so unrelated NT$ figures (e.g. mediation amounts) are not mistaken for the penalty.",
    earliestYear: 2012,
    latestYear: 2026,
    nativeCurrency: "TWD",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        url: "https://www.sfb.gov.tw/en/home.jsp?id=100&parentpath=0,4",
        description:
          "Official FSC Securities and Futures Bureau administrative-sanction listing (English), the source scraped by the live loader.",
      },
      {
        label: "Taiwan FSC (parent authority)",
        url: "https://www.fsc.gov.tw/en/home.jsp?id=74",
        description: "Financial Supervisory Commission parent-authority home.",
      },
    ],
  },
  CVM: {
    ...
    count: 557,
    dataQuality: "Tested live loader",
    note: "Live CVM sanction-proceedings dataset published from the official accused-level open-data ZIP. The feed captures sanctioned respondents and official sanction-status events even where fine amounts are not published in structured form.",
    earliestYear: 2021,
    latestYear: 2026,
    nativeCurrency: "BRL",
    defaultCurrency: "GBP",
  ...
  CNBV: {
    ...
    years: "2017-2026",
    count: 11206,
    dataQuality: "Official sanctions API reconciled",
    note: "Live official CNBV sanctions API coverage. Monetary penalties, reprimands, suspensions and other published outcomes retain the regulator's entity, conduct, decision date and case-level source route.",
    earliestYear: 2017,
    latestYear: 2026,
    nativeCurrency: "MXN",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        description: "Official CNBV sanctions register and case-detail service.",
        role: "archive",
      },
      {
        label: "CNBV sanctions API",
        url: "https://publicacion-sanciones-service.cnbv.gob.mx/api/sanctions",
        description: "Official machine-readable CNBV sanctions endpoint used by the regulator's public search application.",
        role: "api",
      },
    ],
  },
  CMF: {
    ...
    years: "Pending",
    count: 0,
    dataQuality: "Official archive loader implemented; promotion pending gates",
    note: "Official Chilean regulator researched; promotion remains pending production reconciliation and scheduled-run evidence.",
    earliestYear: 0,
    latestYear: 0,
    nativeCurrency: "CLP",
    defaultCurrency: "GBP",
  ...
  SESC: {
    ...
    count: 66,
    dataQuality: "Tested live loader",
    note: "Live SESC enforcement loader tested across market misconduct, false disclosure, and financial instruments action archives. Coverage is anchored to English-language enforcement and recommendation pages from 2023 onward.",
    earliestYear: 2023,
    latestYear: 2026,
    nativeCurrency: "JPY",
    defaultCurrency: "GBP",
  ...
  FSCA: {
    ...
    years: "2006-2026",
    count: 576,
    dataQuality: "Official full-archive export reconciled",
    note: "Live official FSCA full-workbook enforcement archive. Two malformed source dates remain quarantined while 576 valid records retain respondent, outcome and official case-document evidence.",
    earliestYear: 2006,
    latestYear: 2026,
    nativeCurrency: "ZAR",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        url: "https://www.fsca.co.za/Enforcement-Actions",
        description:
          "Official FSCA enforcement archive page embedding the regulator's paginated case search.",
        role: "archive",
      },
      {
        label: "FSCA enforcement case archive",
        url: "https://prod-entitysearchwebapplication.azurewebsites.net/enforcement-actions",
        description: "Official FSCA case archive and full-workbook export with dates, respondents, contraventions, outcomes, and direct order URLs.",
        role: "archive",
      },
    ],
  },
  ...
  FDIC: {
    ...
    years: "1989-2026",
    count: 11139,
    dataQuality: "Live official EDOS register",
    note: "Ingested live from the official FDIC Enforcement Decisions & Orders register (11,139 orders after dropping masked/redacted parties; the register spans 1975-2026 but all pre-1989 rows are masked, so published records span 1989-2026). The register is a Salesforce Lightning app; the loader renders it with a headless browser (Playwright/Chromium, fragile lane) and downloads the official 'Download All' CSV export. Each (order × respondent) becomes one record; the civil money penalty is paired per-respondent and fails toward null for prohibition/cease-and-desist orders with no penalty.",
    earliestYear: 1989,
    latestYear: 2026,
    nativeCurrency: "USD",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        label: "FDIC Enforcement Decisions & Orders",
        url: "https://orders.fdic.gov/s/searchform",
        description:
          "Official FDIC Enforcement Decisions and Orders register (EDOS); the loader downloads its full CSV export.",
      },
    ],
  },
  FRB: {
    ...
    years: "1989-2026",
    count: 2882,
    dataQuality: "Live official CSV export",
    note: "Ingested live from the official enforcement-actions CSV export (2,882 actions, 1989-2026; ~362 carry a parsed Civil Money Penalty amount, the rest are non-monetary Written Agreements / C&D / prohibitions).",
    earliestYear: 1989,
    latestYear: 2026,
    nativeCurrency: "USD",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        description:
          "Official Federal Reserve enforcement actions search tool and CSV export.",
      },
    ],
  },
  SPK: {
    ...
    flag: "🇹🇷",
    navOrder: 64,
    overviewPath: "/regulators/spk",
    years: "2016-2026",
    count: 2226,
    dataQuality: "Live open-data feed",
    note: "Ingested live from the official SPK open-data JSON web service (2,252 administrative monetary penalties scraped, 2016-2026; every record carries a TRY amount; deduplicated to the canonical evidence set for publication). Turkish source text is preserved verbatim.",
    earliestYear: 2016,
    latestYear: 2026,
    nativeCurrency: "TRY",
    defaultCurrency: "EUR",
    ...
    officialSources: [
      {
        ...
        url: "https://ws.spk.gov.tr/help",
        description:
          "Official SPK open-data web service documenting the administrative monetary penalty endpoints scraped by the live loader.",
      },
    ],
  },
  GHSEC: {
    code: "GHSEC",
    name: "Ghana SEC",
    fullName: "Securities and Exchange Commission, Ghana",
    country: "Ghana",
    countryCode: "GH",
    region: "Africa",
    strategicBucket: "high_signal_global",
    ...
    flag: "🇬🇭",
    navOrder: 59,
    overviewPath: "/regulators/ghsec",
    years: "2019-2026",
    count: 68,
    dataQuality: "Live official licence tables",
    note: "Ingested live from the official suspension/revocation/cessation licence tables (68 licence actions through 2026). These are licence enforcement actions rather than monetary penalties, so amounts are null by nature.",
    earliestYear: 2019,
    latestYear: 2022,
    nativeCurrency: "GHS",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        description:
          "Official Ghana SEC page listing suspended, revoked, and ceased licences, scraped by the live loader.",
      },
    ],
  },
  IOMFSA: {
    code: "IOMFSA",
    name: "IoM FSA",
    fullName: "Isle of Man Financial Services Authority",
    country: "Isle of Man",
    countryCode: "IM",
    region: "Offshore",
    strategicBucket: "offshore_wealth_centres",
    ...
    flag: "🇮🇲",
    navOrder: 60,
    overviewPath: "/regulators/iomfsa",
    years: "2019-2025",
    count: 21,
    dataQuality: "Live browser-rendered table",
    note: "Ingested live from the enforcement-action table (21 civil penalties, 2019-2025; every record carries a GBP amount). The site's WAF rejects plain HTTP, so the loader renders the page with a headless browser (Playwright/Chromium) and runs in the fragile lane.",
    earliestYear: 2019,
    latestYear: 2025,
    nativeCurrency: "GBP",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        ...
        description:
          "Official Isle of Man FSA enforcement-action table, scraped by the live loader via a headless browser.",
      },
    ],
  },
  AMMC: {
    ...
    flag: "🇲🇦",
    navOrder: 61,
    overviewPath: "/regulators/ammc",
    years: "2019-2024",
    count: 8,
    dataQuality: "Live official sanctions listing",
    note: "Ingested live from the official 'Sanctions pécuniaires' listing (8 named monetary sanctions published, 2019-2024; 2 anonymised decisions with no publishable party name are excluded). The French decision titles are preserved verbatim and the sanctioned party is extracted from them; the monetary figure lives inside each decision PDF, so amounts are null by nature in the listing.",
    earliestYear: 2019,
    latestYear: 2024,
    nativeCurrency: "MAD",
    defaultCurrency: "EUR",
    ...
    officialSources: [
      {
        label: "AMMC sanctions pécuniaires",
        url: "https://www.ammc.ma/fr/decisions/sanctions-pecuniaires",
        description:
          "Official AMMC listing of monetary sanction decisions (French), scraped by the live loader.",
      },
    ],
  },
  CNV: {
    code: "CNV",
    name: "CNV",
    fullName: "Comisión Nacional de Valores",
    country: "Argentina",
    countryCode: "AR",
    region: "Latin America",
    strategicBucket: "high_signal_global",
    ...
    flag: "🇦🇷",
    navOrder: 62,
    overviewPath: "/regulators/cnv",
    years: "2025-2026",
    count: 19,
    dataQuality: "Live official disciplinary grid",
    note: "Ingested live from the official 'Resoluciones Disciplinarias' grid (19 sanctioned parties across the disciplinary-resolution table, 2025-2026 in the current listing). One resolution can sanction several parties (rowspan grouping), so each (resolution × party) becomes one record. The Spanish case titles are preserved verbatim; the monetary figure lives in each resolution PDF, so amounts are null by nature in the grid.",
    earliestYear: 2025,
    latestYear: 2026,
    nativeCurrency: "ARS",
    defaultCurrency: "EUR",
    ...
    officialSources: [
      {
        label: "CNV resoluciones disciplinarias",
        url: "https://www.cnv.gov.ar/SitioWeb/ResolucionesDisciplinarias",
        description:
          "Official CNV disciplinary-resolutions grid (Spanish), scraped by the live loader.",
      },
    ],
  },
  FSS: {
    code: "FSS",
    name: "FSS Korea",
    fullName: "Financial Supervisory Service",
    country: "South Korea",
    countryCode: "KR",
    region: "APAC",
    strategicBucket: "high_signal_global",
    ...
    flag: "🇰🇷",
    navOrder: 63,
    overviewPath: "/regulators/fss",
    years: "1998-2026",
    count: 40,
    dataQuality: "Live official press-release board",
    note: "Ingested live from the FSS English press-release board filtered to the 'Supervision-Examination' category (40 supervisory/enforcement press releases through 2026; paginated). English press-release titles are preserved verbatim. FSS press releases seldom state a monetary figure in English, so amounts are null by nature. Distinct from the FSC Korea (fsc.go.kr) source.",
    earliestYear: 1998,
    latestYear: 2022,
    nativeCurrency: "KRW",
    defaultCurrency: "EUR",
    ...
    officialSources: [
      {
        label: "FSS press releases (Supervision-Examination)",
        url: "https://www.fss.or.kr/eng/bbs/B0000211/list.do?menuNo=300147&selectCate2=1007",
        description:
          "Official FSS English press-release board, supervision/examination category, scraped by the live loader.",
      },
    ],
  },
  CMASA: {
  ...
  OSC: {
    ...
    officialSources: [
      {
        label: "OSC unpaid sanctions register",
        url: "https://www.osc.ca/en/enforcement/osc-sanctions/individuals-or-companies-unpaid-osc-sanctions",
        description:
          "Official OSC delinquent respondent list covering unpaid administrative penalties, disgorgement orders, and costs.",
      },
      {
        label: "Capital Markets Tribunal proceedings",
        url: "https://www.capitalmarketstribunal.ca/en/proceedings",
        description:
          "Official tribunal proceeding pages linked from the OSC sanctions register, used to resolve sanction dates and order documents.",
      },
    ],
  },
  CONSOB: {
    ...
    officialSources: [
      {
        ...
        url: "https://www.cbn.gov.ng/Documents/Notices.html",
        description:
          "Official CBN notices archive and JSON feed, including licence actions, closures, and supervision notices.",
        role: "archive",
      },
      {
        label: "CBN notices JSON feed",
  ...
  NGSEC: {
    ...
    flag: "🇳🇬",
    navOrder: 58,
    overviewPath: "/regulators/ngsec",
    years: "2021-2025",
    count: 41,
    dataQuality: "Official enforcement archive reconciled",
    note: "Live Nigerian SEC enforcement coverage, tracked separately from the US SEC. The feed covers enforcement updates, referred cases, company actions, APC matters and litigation pages; one malformed source summary remains quarantined.",
    earliestYear: 2021,
    latestYear: 2025,
    nativeCurrency: "NGN",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      {
        label: "NGSEC enforcement hub",
        url: "https://www.sec.gov.ng/enforcements/",
        description: "Official Nigerian SEC enforcement hub.",
        role: "archive",
      },
      {
        label: "NGSEC enforcement updates",
        url: "https://www.sec.gov.ng/enforcements/keep-track-of-enforcement-updates/",
        description: "Official Nigerian SEC enforcement update archive with dated detail pages.",
        role: "archive",
      },
    ],
  },
