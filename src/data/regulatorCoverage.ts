...
const REGULATOR_COVERAGE_SEED: Record<string, RegulatorCoverageSeed> = {
  ...
  FSCA: {
    ...
    count: 0,
    dataQuality: "Official archive loader implemented; promotion pending gates",
    note: "Official FSCA Power Pages/Blazor enforcement archive loader is implemented. Promotion remains pipeline until full pagination, production load, and two clean scheduled runs are evidenced.",
    earliestYear: 0,
    latestYear: 0,
    nativeCurrency: "ZAR",
    defaultCurrency: "GBP",
    ...
    officialSources: [
      ...
      },
      {
        ...
        description: "Official FSCA paginated case table with dates, respondents, contraventions, outcomes, and order controls.",
        role: "archive",
      },
    ],
  },
