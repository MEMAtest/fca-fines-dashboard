...
const REGULATOR_COVERAGE_SEED: Record<string, RegulatorCoverageSeed> = {
  ...
  FDIC: {
    ...
    count: 11137,
    dataQuality: "Live loader verified (dry-run)",
    note: "Live loader built and verified against the official FDIC Enforcement Decisions & Orders register (11,137 orders after dropping masked/redacted parties, 1975-2026). The register is a Salesforce Lightning app; the loader renders it with a headless browser and downloads the official 'Download All' CSV export. Each (order × respondent) becomes one record; the civil money penalty is paired per-respondent and fails toward null for prohibition/cease-and-desist orders with no penalty. Ingestion and public coverage are not yet live.",
    earliestYear: 1975,
    latestYear: 2026,
    nativeCurrency: "USD",
    defaultCurrency: "GBP",
