...
import { countryRiskEvidenceRows, type CountryRiskEvidenceBundle } from "../data/countryRiskEvidenceExport.js";
...
export function CountryRiskEvidencePdf({ bundle }: { bundle: CountryRiskEvidenceBundle }) {
