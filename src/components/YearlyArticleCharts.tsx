...
export const yearlyFCAData: Record<number, YearlyData> = {
  2025: {
    ...
    largestFine: {
      ...
      amount: 44_000_000,
      breach: "Financial Crime Controls",
    },
    monthlyData: [
    ...
    keyThemes: [
      "Consumer Duty enforcement begins",
      "Continued AML focus",
    ...
    topFirms: [
      {
        firm: "Credit Suisse",
        amount: 14_719_020,
        breach: "Archegos/Risk Management",
      },
  ...
  2020: {
    ...
    topFirms: [
      ...
      {
        firm: "Standard Life Aberdeen",
        amount: 31_000_000,
        breach: "Linking Issues",
      },
    ],
    keyThemes: [
      "1MDB enforcement",
  ...
  2019: {
    ...
    largestFine: {
      ...
      amount: 102_163_200,
      breach: "AML Correspondent Banking",
    },
    monthlyData: [
  ...
  2018: {
    ...
    avgFine: 3_333_333,
    largestFine: {
      firm: "Tesco Personal Finance",
      amount: 16_400_000,
      breach: "Cyber Attack Response",
    },
    monthlyData: [
  ...
  2017: {
    ...
    largestFine: {
      ...
      amount: 163_076_224,
      breach: "Russian Mirror Trades AML",
    },
    monthlyData: [
    ...
    topFirms: [
      ...
      {
        firm: "Merrill Lynch International",
        amount: 34_524_000,
        breach: "Reporting",
      },
  ...
  2016: {
    ...
    largestFine: {
      ...
      amount: 8_200_000,
      breach: "Non-Advised Annuity Sales",
    },
    monthlyData: [
  ...
  2015: {
    ...
    keyThemes: [
      "FX scandal concludes at Barclays",
      "PPI enforcement",
      "Record total fines",
    ],
  ...
  2014: {
    ...
    keyThemes: [
      "FX scandal - coordinated enforcement",
      "Record year for fines",
      "Major bank accountability",
    ],
    regulatoryFocus: [
      "FX Market Conduct",
  ...
  2013: {
    ...
    avgFine: 13_542_857,
    largestFine: {
      firm: "JPMorgan Chase Bank",
      amount: 137_610_000,
      breach: "London Whale CIO Losses",
    },
    monthlyData: [
    ...
    topFirms: [
      ...
      { firm: "Rabobank", amount: 105_000_000, breach: "LIBOR" },
      {
        firm: "Lloyds Banking Group",
        amount: 28_000_000,
        breach: "Insurance Sales",
      },
    ],
    keyThemes: [
      "FCA established (April 2013)",
      "London Whale aftermath",
      "LIBOR scandal continues",
    ],
  ...
  return (
    <div className="yearly-chart">
      <h4 className="yearly-chart-title">
        Monthly Enforcement Activity - {year}
      </h4>
      ...
      <p className="yearly-chart-caption">
        Bar: Fine amounts | Line: Number of enforcement actions
      </p>
    </div>
  );
}
...
export function BreachCategoryChart({ data, year }: BreachChartProps) {
  ...
  return (
    <div className="yearly-chart">
      ...
      <p className="yearly-chart-caption">
        Total: {formatCurrency(total)} across{" "}
        {data.reduce((sum, item) => sum + item.count, 0)} enforcement actions
      </p>
    </div>
  );
}
...
export function TopFirmsChart({ data, year }: TopFirmsChartProps) {
  const chartData = data.slice(0, 5).map((item) => ({
    ...item,
    shortFirm:
      item.firm.length > 25 ? item.firm.substring(0, 25) + "..." : item.firm,
  }));
...
export function YearOverYearChart({ years }: YoYComparisonProps) {
  ...
  return (
    <div className="yearly-chart yearly-chart--wide">
      <h4 className="yearly-chart-title">
        FCA Enforcement Trend: {years[0]}-{years[years.length - 1]}
      </h4>
