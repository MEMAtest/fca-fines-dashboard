...
import { mockTimelineData, mockFineRecords } from "../test/mockData.js";
...
describe("TimelineChart", () => {
  ...
  describe("rendering", () => {
    ...
    it("renders description text", () => {
      ...
      expect(
        screen.getByText(/Tap a month to focus filters/),
      ).toBeInTheDocument();
    });
    ...
    it("renders hint text", () => {
      ...
      expect(
        screen.getByText(/Tap to focus • Brush to filter a window/),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("help tooltip", () => {
    it("renders help button with tooltip", () => {
      ...
      const helpButton = screen.getByRole("button", {
        name: /View monthly enforcement totals/,
      });
