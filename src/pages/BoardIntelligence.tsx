...
export function BoardIntelligence() {
  ...
  return (
    <div className="board-quick">
      ...
      <div className="board-quick__footer"><span>Generated by RegActions from public regulatory evidence.</span><span>Need a tailored board advisory pack? <a href="https://memaconsultants.com" target="_blank" rel="noreferrer">MEMA Consultants</a></span></div>
