...
<head>
  ...
  <style>
    ...
    .header { background: linear-gradient(135deg, #0FA77D 0%, #0B8463 100%); border-radius: 12px 12px 0 0; padding: 32px; text-align: center; }
    ...
    .cta-block { background: linear-gradient(135deg, rgba(15, 167, 125, 0.08), rgba(59, 130, 246, 0.08)); border-radius: 12px; padding: 24px; margin: 24px 0; text-align: center; }
    .cta-block h3 { margin: 0 0 8px 0; color: #111827; font-size: 16px; }
    .cta-block p { margin: 0 0 16px 0; color: #4b5563; font-size: 14px; }
    .cta-button { display: inline-block; background: #0FA77D; color: white !important; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-weight: 600; font-size: 14px; }
